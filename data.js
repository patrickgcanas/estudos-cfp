...
<p>Competências: política monetária, cambial, de crédito e da dívida pública federal.</p>

<h3>CNSP — Conselho Nacional de Seguros Privados</h3>
<p>Órgão normativo para <strong>seguros, resseguros, previdência privada aberta</strong> (PGBL/VGBL) e capitalização. Presidido pelo Ministro da Fazenda.</p>
...
<li>Controlar o crédito e as taxas de juros (taxa SELIC, compulsório bancário)</li>
<li>Conceder autorização para funcionamento de instituições financeiras</li>
</ul>

<h3>CVM — Comissão de Valores Mobiliários</h3>
<p>Autarquia federal que regula e fiscaliza o <strong>mercado de valores mobiliários</strong>. Supervisiona:</p>
<ul>
...
<li><strong>CETIP/B3</strong>: registro e liquidação de títulos privados</li>
    ...
    fc: [
      ...
      { q: "Qual a diferença entre banco comercial e banco de investimento?", a: "Banco comercial: capta depósitos à vista, crédito de curto prazo, pessoa física e PJ. Banco de investimento: sem depósito à vista, crédito médio/longo prazo, underwriting e M&A corporativo." },
    ...
    q: [
      {
        t: "O Conselho Monetário Nacional (CMN) é presidido por:",
        o: ["A) Presidente do BACEN", "B) Ministro da Fazenda", "C) Presidente da República", "D) Presidente da CVM"],
        c: 1,
        f: "O Ministro da Fazenda preside o CMN. O BACEN tem seu próprio presidente que integra o CMN como membro, mas não o preside. Esse ponto cai com frequência na prova — não confunda presidir com integrar."
      },
      {
        t: "Uma sociedade corretora de títulos e valores mobiliários (CTVM) é fiscalizada principalmente por:",
        o: ["A) BACEN", "B) SUSEP", "C) CVM", "D) PREVIC"],
        c: 2,
        f: "A CVM regula e fiscaliza o mercado de valores mobiliários, incluindo corretoras (CTVM) e distribuidoras (DTVM). O BACEN também tem alguma atuação em aspectos operacionais, mas a supervisão principal é da CVM."
      },
      {
        t: "Uma seguradora que oferece planos PGBL e VGBL é supervisionada pela:",
        o: ["A) PREVIC", "B) CVM", "C) CNPC", "D) SUSEP"],
        c: 3,
        f: "PGBL e VGBL são produtos de previdência privada ABERTA, regulados pela SUSEP. A PREVIC cuida apenas da previdência FECHADA (fundos de pensão/EFPC). O CNPC é o órgão normativo da previdência fechada — não supervisiona."
      },
      {
        t: "Qual das seguintes instituições NÃO é classificada como instituição financeira bancária?",
        o: ["A) Banco Comercial", "B) Caixa Econômica Federal", "C) Banco Múltiplo com carteira comercial", "D) Banco de Investimento"],
        c: 3,
        f: "O Banco de Investimento NÃO pode captar depósitos à vista, portanto não é bancário. Bancos comerciais, CEF e bancos múltiplos com carteira comercial são bancários porque captam depósitos à vista e criam moeda escritural."
      }
    ],
    al: [
