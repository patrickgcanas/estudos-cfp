...
<p>O VPL e a TIR são ferramentas que o planejador financeiro usa para avaliar investimentos do cliente — seja expansão de negócio, compra de imóvel para renda, ou troca de financiamento. O CMPC define o custo de oportunidade: se o projeto não bater o CMPC da empresa, destrói valor.</p>
  ...
  10: {
    "titulo": "Planejamento de Seguros e Gestão de Risco I",
    "exp": "<div class=\"content-body\"><h2>Fundamentos da Gestão de Risco</h2><p>O planejamento financeiro deve considerar como os seguros se encaixam nas estratégias de gestão de riscos que podem comprometer o patrimônio e o bem-estar do cliente. A Pirâmide de Maslow ajuda a situar a proteção: antes de buscar realizações pessoais, o indivíduo precisa satisfazer necessidades de segurança — e é aí que entra o seguro.</p><p>Gerenciar risco não é apenas medir o impacto financeiro de uma perda, mas criar um plano de ação para preveni-la ou reduzi-la. O processo segue seis etapas: <strong>determinar o contexto</strong> (externo: cultural, legal, regulatório, político, macroeconômico; interno: objetivos e estratégias do cliente), <strong>identificar os riscos</strong> (fontes, impactos, eventos possíveis), <strong>analisar os riscos</strong> (quantitativa e qualitativamente), <strong>avaliar os riscos</strong> (priorização), <strong>tratar os riscos</strong> (evitar, excluir ou proteger) e <strong>monitorar e revisar</strong> constantemente. Como resume Eleanor Blayney, CFP®: sem medidas para minimizar riscos, toda riqueza construída ao longo do tempo pode ser rapidamente destruída por eventos inesperados.</p><h3>As 5 Regras de Blayney</h3><ul><li><strong>(1) Proteja apenas o que não pode perder:</strong> avalie os ativos e serviços cuja perda causaria prejuízo devastador — é a base para dimensionar o seguro de vida.</li><li><strong>(2) Contrate seguro para perdas financeiras, não emocionais:</strong> perdas emocionais não são repostas por dinheiro; a análise deve ser sempre pelo impacto financeiro.</li><li><strong>(3) Concentre-se na melhor proteção contra perda:</strong> \"perfumarias\" (ex.: assistência PET gratuita) são critério final de escolha, nunca prioridade.</li><li><strong>(4) Mantenha baixo o custo dos seguros:</strong> se o custo está alto, avalie estratégias alternativas para reduzir o risco (ex.: parar de fumar é mais barato que um seguro contra câncer de pulmão; cerca elétrica pode ser mais barata que seguro residencial).</li><li><strong>(5) Analise seguros pessoais e comerciais:</strong> considere também os riscos da atividade profissional e a perda de renda.</li></ul><h3>Tratamento do Risco (ISO 31.000) e Tipos de Risco</h3><p>Conforme a ISO 31.000, o tratamento do risco segue uma cronologia de opções, do mais desejável ao último recurso: <strong>evitar</strong> a atividade que origina o risco; <strong>remover a fonte</strong> de risco; <strong>mudar a natureza ou probabilidade</strong>; <strong>mudar as consequências</strong> do evento; <strong>dividir o risco</strong> com outros; e, por fim, <strong>manter o risco</strong>.</p><p>Distinguem-se dois tipos de risco: <strong>Risco Puro</strong> — gera apenas perdas, sem possibilidade de ganho (ex.: colisão de veículo) — e <strong>Risco Especulativo</strong> — pode gerar ganho ou perda (ex.: investimentos em ações, imóveis, renda fixa). Somente o risco puro é objeto de seguro.</p><h3>Risco, Impacto e Dano</h3><p>O <strong>Risco</strong> pode ser <strong>Segurável</strong> (eventos casuais, aleatórios, mensuráveis estatisticamente e não catastróficos, seguindo a \"lei dos grandes números\" — furacões, terremotos) ou <strong>Não Segurável</strong> (riscos sociais assumidos pelo governo por interesse público, como seguro-desemprego e previdência estatal). O <strong>Impacto (Severidade)</strong> é o prejuízo causado pelo risco ocorrido. O <strong>Dano</strong> é o risco multiplicado pelo seu impacto: seguro de vida por morte tem alto impacto mas baixa probabilidade; roubo de celular tem alta probabilidade mas baixo impacto.</p><h3>Estratégias: Retenção x Transferência de Risco</h3><p><strong>Retenção de Risco (Autosseguro):</strong> o indivíduo acumula recursos próprios para assumir uma perda potencial futura, sem contratar seguradora, mantendo o risco no nível atual (ex.: não segurar um carro de luxo quando a probabilidade e o impacto financeiro são baixos para o patrimônio do segurado). <strong>Transferência de Risco:</strong> reduz o impacto ao transferir o risco a um terceiro (seguradora), mediante pagamento de prêmio (ex.: pai que contrata seguro de vida para garantir os estudos da filha, esteja ele vivo ou não).</p><h2>Planejamento de Seguros e Ciclo de Vida</h2><p>O principal objetivo da contratação de seguros é transferir um risco próprio a um terceiro mediante prêmio. Os motivos se agrupam em três blocos: <strong>Pessoal e Familiar</strong> (morte, invalidez permanente ou incapacidade temporária, doença grave, responsabilidade civil, saúde, perda de renda), <strong>Financeiro</strong> (responsabilidade civil, crédito e financiamento — prestamista e habitacional) e <strong>Bens Patrimoniais</strong> (residência, automóvel, bens em geral).</p><h3>Etapas do Planejamento de Seguros</h3><ul><li><strong>Identificar os riscos:</strong> coleta de dados sobre a atual cobertura de seguros e possíveis obrigações financeiras;</li><li><strong>Avaliar a necessidade de transferência do risco:</strong> analisar o custo x benefício para o cliente;</li><li><strong>Analisar as coberturas disponíveis:</strong> avaliar produtos, idoneidade e histórico de seguradoras e corretores;</li><li><strong>Monitorar</strong> o planejamento e os valores de cobertura em função do ciclo de vida, revisando ao menos uma vez ao ano.</li></ul><h3>Fases do Ciclo de Vida</h3><table class=\"data-table\"><tr><th>Fase</th><th>Idade</th><th>Características</th></tr><tr><td>Fundação da Riqueza</td><td>18 a 28 anos</td><td>Foco em acumular via trabalho/poupança para a aposentadoria, não na proteção; maior tolerância a risco, mas poucos recursos</td></tr><tr><td>Acumulação de Capital</td><td>28 a 40 anos</td><td>Início de carreira e constituição de família; seguro de vida deve ser condizente com a necessidade real (vitalício é barato nesta faixa)</td></tr><tr><td>Conservação/Proteção de Capital</td><td>40 a 60 anos</td><td>Auge da carreira, filhos ainda estudando; seguros de vida e saúde de extrema relevância</td></tr><tr><td>Distribuição/Transferência de Capital</td><td>60 anos ou mais</td><td>Próximo da aposentadoria; reduzir exposição a risco nos investimentos; seguros de vida e saúde caros, mas necessários (inventário, gastos hospitalares)</td></tr></table><h3>Dimensionamento do Seguro de Vida</h3><p><strong>Método do Valor da Vida Humana:</strong> avalia a capacidade de renda do segurado para arcar com o custo dos dependentes em caso de morte ou invalidez, multiplicando o gasto anual com a família pelos anos restantes de trabalho.</p><p><em>Exemplo:</em> Rafael tem 40 anos, trabalharia até os 60 (20 anos), ganha R$ 100 mil/ano, paga 20% de IR e consome 30% para si. Sobra 50% para a família: R$ 50.000/ano. Capital Segurado = 20 anos x R$ 50.000 = <strong>R$ 1.000.000,00</strong>.</p><p><strong>Método da Avaliação das Necessidades:</strong> foca no período de dependência financeira da família, somando configuração familiar, patrimônio, custos de inventário e futuro dos dependentes — mais completo e correto.</p><p><em>Exemplo:</em> Fernanda quer manter o padrão de vida da família por 10 anos: imóvel de R$ 1.000.000 (ITCMD 4% = R$ 40.000; honorários advocatícios 10% = R$ 100.000) mais despesas mensais de R$ 9.000 x 120 meses = R$ 1.080.000. Total = 40.000 + 100.000 + 1.080.000 = <strong>R$ 1.220.000,00</strong> de seguro de vida necessário.</p><h2>Sistema Nacional de Seguros e Classificação dos Seguros</h2><p>Contratamos seguro por três motivos centrais: <strong>Ser Previdente</strong> (preparar-se para minimizar impactos econômicos negativos), <strong>Incerteza</strong> (quanto maior a chance de um evento danoso, maior o prêmio) e <strong>Mutualismo</strong> — a divisão das perdas entre interessados. Exemplo clássico: um carro de R$ 100 mil é roubado a cada 100 existentes (1% de probabilidade); se 100 pessoas contribuírem com R$ 1.000 cada, reúne-se o R$ 100 mil necessário, dividindo o risco entre todos — é sobre esse princípio que as seguradoras operam, cobrando um valor além do estatístico.</p><h3>Órgãos Reguladores e Operadores</h3><table class=\"data-table\"><tr><th>Órgão/Operador</th><th>Função</th></tr><tr><td>CNSP (Conselho Nacional de Seguros Privados)</td><td>Órgão normativo: fixa diretrizes e normas da política de seguros privados, características gerais dos contratos, disciplina o cosseguro e a profissão de corretor</td></tr><tr><td>SUSEP</td><td>Órgão supervisor vinculado ao Ministério da Fazenda: controla e fiscaliza seguro, previdência complementar aberta, capitalização e resseguro; zela pela liquidez e solvência do mercado</td></tr><tr><td>Sociedades Seguradoras</td><td>S.A. que indenizam prejuízos involuntários mediante prêmio; só podem vender seguros, previdência e capitalização</td></tr><tr><td>Corretores de Seguros</td><td>PF/PJ certificados pela SUSEP; representam os interesses do segurado (cliente) frente à seguradora</td></tr><tr><td>Resseguradoras</td><td>S.A. que aceitam transferência de riscos de seguradoras; atuam quando há superação do limite de retenção de risco</td></tr></table><h3>Classificação: Social x Privado, Ramos e Natureza</h3><p><strong>Seguro Social (Público):</strong> obrigatório, sem contrato, operado pelo Estado, cobre apenas necessidades pessoais (Previdência Social, Assistência Social, SUS). <strong>Seguro Privado:</strong> risco assumido por pessoa jurídica, opcional ou obrigatório (ex.: financiamento imobiliário), classificado por <strong>Ramo</strong> (Vida, Saúde, Elementares — automóvel, residencial, RC, garantias, rural) e por <strong>Natureza</strong> (Seguro de Pessoas — vida, acidentes pessoais, saúde, previdência, bem imensurável economicamente; Seguro de Dano — bem patrimonial, valor máximo protegido é o valor do bem).</p><h3>Cosseguro, Resseguro e Retrocessão</h3><table class=\"data-table\"><tr><th>Operação</th><th>Quem realiza</th><th>Anuência do segurado</th><th>Quando ocorre</th></tr><tr><td>Cosseguro</td><td>Duas ou mais seguradoras dividem os riscos de uma apólice (seguradora-líder administra)</td><td>Sempre necessária</td><td>Antes da implementação do seguro</td></tr><tr><td>Resseguro</td><td>Seguradora contrata resseguradora para transferir parte do seu risco</td><td>Não necessária</td><td>Obrigatório ao ultrapassar o limite de retenção; facultativo nos demais casos</td></tr><tr><td>Retrocessão</td><td>Resseguro do resseguro (a própria resseguradora se protege)</td><td>Não necessária</td><td>Quando a resseguradora deseja se proteger</td></tr></table><p>Importante: no cosseguro NÃO há responsabilidade solidária entre as seguradoras — cada uma responde por sua cota.</p><h2>Termos Técnicos do Contrato de Seguro</h2><p>A avaliação de riscos pressupõe três conceitos: <strong>Evento</strong> (fato gerador do sinistro — futuro, possível, incerto e lícito), <strong>Interesse Segurável</strong> (necessário um interesse legítimo relativo a coisas ou pessoas) e <strong>Probabilidade de Eventos</strong> (quanto maior, maior o prêmio).</p><h3>Prêmio: Tipos e Cálculo</h3><p>O Prêmio é o valor pago à seguradora para que ela assuma o risco. O <strong>Prêmio Bruto</strong> não reflete apenas a probabilidade do evento, mas soma composição de risco, carregamento comercial, impostos e lucro:</p><ul><li><strong>Prêmio de Risco</strong> = probabilidade de sinistros x valor dos sinistros (cobre as indenizações);</li><li><strong>Prêmio Puro (PE):</strong> <code>PE = Prêmio de Risco + Carregamento de Segurança</code>;</li><li><strong>Prêmio Comercial (PC):</strong> Prêmio Puro acrescido do carregamento comercial: <code>PC = Prêmio Puro / (1 − Índice de Despesas)</code>, onde <code>Índice de Despesas (ID) = Carregamento Comercial / Prêmio Comercial</code>;</li><li><strong>Prêmio Bruto (PB):</strong> <code>PB = PC x (1 + impostos)</code>;</li><li><strong>Prêmio Adicional:</strong> complemento cobrado por cláusulas extras.</li></ul><p><em>Exemplo:</em> seguradora precisa de R$ 1.000.000/ano para cobrir sinistros de uma frota de 5.000 veículos, com 10% de carregamento de segurança e índice de despesas de 30%. Prêmio de Risco por veículo = 1.000.000 / 5.000 = R$ 200,00. Prêmio Puro = 200 x 1,10 = <strong>R$ 220,00</strong>. Prêmio Comercial = 220 / (1 − 0,30) = 220 / 0,70 = <strong>R$ 314,29</strong>.</p><h3>Importância Segurada, Coberturas e Sinistros</h3><p>A <strong>Importância Segurada</strong> (Capital Segurado nos seguros de vida) é o limite máximo de responsabilidade da seguradora. Nos Seguros de Dano não pode superar o valor do bem; no Seguro de Pessoas não há limite legal, mas a seguradora fixa teto de aceitação. As <strong>Coberturas</strong> podem ser <strong>Básica</strong> (obrigatória), <strong>Adicional/Acessória</strong> (opcional, com prêmio adicional) ou <strong>Compreensiva/Multirriscos</strong> (várias coberturas na mesma apólice), pagas de forma <strong>Única</strong>, em <strong>Renda</strong> ou por <strong>Reembolso</strong>.</p><p><strong>Sinistro</strong> é a ocorrência do risco coberto durante a vigência, de forma involuntária e imprevista. Em seguro de automóvel: <strong>Perda Parcial</strong> quando o reparo não atinge 75% do valor da Tabela FIPE; <strong>Perda Total</strong> quando supera esse percentual (a seguradora pode definir critérios para percentuais inferiores).</p><h3>Danos, Base de Ocorrência e Base de Reclamação</h3><p><strong>Dano Material:</strong> físico a propriedade tangível (deterioração, furto, roubo). <strong>Dano Pessoal</strong> se divide em <strong>Corporal</strong> (lesão física ao corpo), <strong>Moral</strong> (lesão à dignidade/personalidade, inclusive de PJ) e <strong>Estético</strong> (redução do padrão de beleza sem sequela funcional).</p><p><strong>Base de Ocorrência:</strong> o dano deve ocorrer durante a vigência da apólice; a reclamação pode ocorrer até o prazo prescricional (1 ano do segurado contra a seguradora; 3 anos de terceiro contra o segurado-causador). <strong>Base de Reclamação:</strong> o dano deve ocorrer na vigência ou no prazo retroativo (crescente a cada renovação sem interrupção), com reclamação no prazo complementar (gratuito, 1 ano após o vencimento) ou suplementar (mediante prêmio adicional, também 1 ano).</p><h3>Franquia e Carência</h3><p>A <strong>Franquia</strong> é o valor que, em caso de sinistro, a seguradora pode deixar de pagar. <strong>Franquia Simples:</strong> a seguradora só indeniza se o prejuízo superar a franquia, mas aí arca com o valor total. <strong>Franquia Dedutível</strong> (a mais comum): o segurado sempre arca com o valor da franquia, e a seguradora paga o restante. <em>Exemplo:</em> franquia dedutível de R$ 2.000 e conserto de R$ 10.000 → seguradora paga R$ 8.000,00.</p><p><strong>Carência</strong> é o período em que, mesmo ocorrendo sinistro, não há direito ao capital segurado. Não pode exceder metade do prazo de vigência da apólice, exceto suicídio (carência de até 2 anos); no Seguro Saúde, a carência pode chegar a 24 meses para certos procedimentos.</p><h2>Aspectos Legais e Processo de Indenização</h2><p>O contrato de seguro é <strong>Bilateral</strong> (ambas as partes se manifestam), <strong>Oneroso</strong> (desembolso de ambos os lados), <strong>Aleatório</strong> (a seguradora recebe o prêmio com certeza, mas só paga indenização se ocorrer sinistro — não devolve prêmios se não houver sinistro), <strong>Solene</strong> (consentimento formal via proposta e apólice), <strong>Consensual</strong>, <strong>Formal e Nominado</strong>, de <strong>Adesão</strong> e pautado na <strong>Boa-Fé</strong>.</p><p>Definições-chave: <strong>Segurado</strong> (com Estipulante, quem contrata, e Beneficiário, quem recebe a indenização); <strong>Segurador</strong> (autorizado pela SUSEP); <strong>Taxas</strong> (estatística, pura e comercial); <strong>Indenização</strong> (valor pago ao beneficiário, isento de Imposto de Renda). Os documentos do processo são a <strong>Proposta</strong> (não é ato jurídico contratual — apenas formaliza o interesse), a <strong>Apólice</strong> (o contrato em si, aceito pela seguradora), o <strong>Endosso/Aditivo</strong> (altera dados da apólice em comum acordo) e a <strong>Rescisão</strong> (dissolução antecipada por acordo — sem acordo, chama-se cancelamento).</p><h3>Ressarcimento e Sub-rogação</h3><p><strong>Sub-rogação:</strong> direito da seguradora, após pagar a indenização, de cobrar de terceiro culpado pelo dano — exceto se o terceiro for cônjuge, ascendente, descendente ou parente do segurado (salvo dolo), e NÃO se aplica ao Seguro de Vida. <em>Exemplo:</em> Rafael tem seu carro atingido por terceiro sem seguro; a seguradora de Rafael paga o conserto de R$ 10.000 e depois cobra esse valor na justiça do terceiro causador.</p><h3>Obrigações Legais, Nulidade e Anulabilidade</h3><p>A <strong>Seguradora</strong> deve pagar o sinistro coberto; o <strong>Segurado</strong> deve pagar o prêmio, agir de boa-fé e comunicar alterações de risco; o <strong>Corretor</strong> representa legalmente o segurado. Um contrato é <strong>Nulo</strong> quando fere princípios básicos do ordenamento jurídico (ex.: seguro de vida para pessoa já morta) — sem prazo prescricional. É <strong>Anulável</strong> por vício de erro, dolo, coação, estado de perigo, lesão ou fraude por interesse de uma das partes (ex.: omitir doença grave) — prazo de 4 anos para esses vícios, ou 2 anos supletivo quando a lei não estipular prazo.</p><h3>Prescrição</h3><table class=\"data-table\"><tr><th>Tipo</th><th>Prazo</th></tr><tr><td>Seguros em geral</td><td>1 ano</td></tr><tr><td>Seguro de Vida (beneficiário x seguradora)</td><td>3 anos</td></tr><tr><td>Seguro de RC (ação do 3º prejudicado)</td><td>1 ano da reclamação</td></tr><tr><td>Seguro de RC Obrigatório</td><td>3 anos</td></tr></table><h3>Processo de Indenização: Prazos e Exclusões</h3><p>Após a documentação exigida, a seguradora deve pagar em até 30 dias (prazo suspenso se solicitar novos documentos). Conceitos centrais: <strong>Notificação de Sinistro</strong> (comunicação imediata pelo segurado); <strong>Prova de Perda</strong> (cabe ao segurado comprovar o sinistro); <strong>Ônus da Prova</strong> (é da seguradora — ela deve pagar salvo se provar que não deve). <strong>Exclusões</strong> podem ser por força de lei, por força de contrato, por riscos catastróficos (guerras, pandemias) ou por riscos com carteira específica (ex.: carro roubado dentro da garagem de imóvel com seguro residencial). Também não são indenizáveis <strong>Pedidos Fraudulentos</strong> (simular roubo, omitir informação) e <strong>Perdas por Conta Própria</strong> (negligência do segurado, como deixar a porta aberta).</p><h3>Subseguro e Sobresseguro</h3><p><strong>Subseguro:</strong> se o capital segurado, na data do sinistro, for inferior ao valor do objeto, a seguradora só responde na proporção contratada (ex.: seguro de R$ 100 mil sobre bem de R$ 150 mil → seguradora paga proporcionalmente ao capital de R$ 100 mil). <strong>Sobresseguro:</strong> é permitido contratar mais de um seguro para o mesmo bem, mas a indenização total não pode ultrapassar o valor do objeto — as seguradoras compõem uma única indenização. Essa regra NÃO se aplica ao seguro de vida (a vida não tem preço; os capitais de múltiplas apólices se somam), mas a comunicação por escrito às demais seguradoras permanece obrigatória.</p><h3>Quantificando a Perda: Risco Absoluto, Relativo e Total</h3><p>O <strong>Limite Máximo de Garantia (LMG)</strong> é o teto que a seguradora paga. No <strong>Risco Absoluto</strong>, a seguradora arca com o prejuízo até o LMG, deduzida a franquia, sem cláusula de rateio. Nos demais modelos, aplica-se a <strong>Cláusula de Rateio</strong> quando o Valor em Risco Apurado (VRA) no sinistro supera o valor declarado.</p><p><strong>Risco Relativo</strong> — o segurado declara o Valor em Risco Declarado (VRD); se o VRA apurado for maior: <code>Indenização = (VRD / VRA) x Dano</code>. <em>Exemplo:</em> Rafael segurou um bem com LMG de R$ 2.600.000,00; no sinistro, o bem foi avaliado (VRA) em R$ 5.600.000,00 e o dano foi de R$ 1.200.000,00. Rateio = 2.600.000 / 5.600.000 = 46,43%. Indenização = 1.200.000 x 46,43% = <strong>R$ 557.160,00</strong>.</p><p><strong>Risco Total</strong> — o LMG é fixado como o valor atual do bem ou múltiplo dele (<code>LMG = k x VA</code>); se LMG for menor que o VRA apurado, há rateio: <code>Indenização = (LMG / VRA) x Dano</code>. <em>Exemplo:</em> Gustavo tem LMG de R$ 3.000.000,00; o bem foi avaliado em R$ 6.000.000,00 e o dano foi de R$ 1.000.000,00. Rateio = 3.000.000 / 6.000.000 = 50%. Indenização = 1.000.000 x 50% = <strong>R$ 500.000,00</strong>. Se houver percentual de redução (k) contratado — por exemplo, 70% — primeiro ajusta-se o VRA: 6.000.000 x 70% = R$ 4.200.000,00; Rateio = 3.000.000 / 4.200.000 = 71,43%; Indenização = 1.000.000 x 71,43% = <strong>R$ 714.285,00</strong>.</p></div>",
    "mapa": {
      "root": "Planejamento de Seguros e Gestão de Risco I",
      "branches": [
        { "label": "Fundamentos da Gestão de Risco", "icon": "🎯", "color": "#3b82f6", "children": [
          { "label": "5 Regras de Blayney", "detail": "Proteger só o que não pode perder; custo baixo; foco financeiro" },
          { "label": "ISO 31.000", "detail": "Evitar, remover, mudar, dividir ou manter o risco" },
          { "label": "Risco Puro x Especulativo", "detail": "Só o risco puro é segurável (sem chance de ganho)" },
          { "label": "Dano = Risco x Impacto", "detail": "Segurável x não segurável; severidade do prejuízo" },
          { "label": "Retenção x Transferência", "detail": "Autosseguro x pagar prêmio para transferir risco" }
        ]},
        { "label": "Planejamento de Seguros e Ciclo de Vida", "icon": "📈", "color": "#10b981", "children": [
          { "label": "Objetivos", "detail": "Pessoal/familiar, financeiro, bens patrimoniais" },
          { "label": "Etapas do planejamento", "detail": "Identificar, avaliar, analisar coberturas, monitorar" },
          { "label": "Fases do ciclo de vida", "detail": "Fundação (18-28), Acumulação (28-40), Conservação (40-60), Distribuição (60+)" },
          { "label": "Valor da Vida Humana", "detail": "Renda familiar anual x anos restantes de trabalho" },
          { "label": "Avaliação das Necessidades", "detail": "Inventário + ITCMD + honorários + despesas futuras" }
        ]},
        { "label": "Sistema Nacional de Seguros", "icon": "🏛️", "color": "#f59e0b", "children": [
          { "label": "CNSP x SUSEP", "detail": "Órgão normativo x órgão supervisor (Min. Fazenda)" },
          { "label": "Operadores", "detail": "Seguradoras, corretores, resseguradoras" },
          { "label": "Classificação", "detail": "Social x privado; ramos (vida/saúde/elementares); natureza" },
          { "label": "Cosseguro x Resseguro", "detail": "Cosseguro exige anuência; resseguro não" }
        ]},
        { "label": "Termos Técnicos do Seguro", "icon": "📋", "color": "#8b5cf6", "children": [
          { "label": "Prêmio", "detail": "Puro, comercial, bruto; PE = risco + carregamento segurança" },
          { "label": "Sinistro e coberturas", "detail": "Perda parcial/total (75% Tabela FIPE); básica/adicional" },
          { "label": "Danos", "detail": "Material, corporal, moral, estético" },
          { "label": "Franquia e carência", "detail": "Simples x dedutível; carência até metade da vigência" }
        ]},
        { "label": "Aspectos Legais e Indenização", "icon": "⚖️", "color": "#ef4444", "children": [
          { "label": "Contrato de seguro", "detail": "Bilateral, oneroso, aleatório, boa-fé, adesão" },
          { "label": "Nulidade x Anulabilidade", "detail": "Sem prazo x 4 anos (vícios) ou 2 anos supletivo" },
          { "label": "Subseguro x Sobresseguro", "detail": "Indenização proporcional x soma limitada ao bem" },
          { "label": "Risco Relativo e Total", "detail": "Rateio: (VRD ou LMG / VRA) x Dano" }
        ]}
      ]
    },
    "tags": ["gestão de risco", "seguros", "prêmio", "franquia", "carência", "sinistro", "CNSP", "SUSEP", "cosseguro", "resseguro", "sub-rogação", "subseguro", "sobresseguro", "risco relativo", "risco total", "valor da vida humana", "avaliação das necessidades", "apólice"],
    "fc": [
      { "q": "Quais são as 5 Regras de Blayney para análise de seguros?", "a": "(1) Proteger apenas o que não pode perder; (2) contratar seguro para perdas financeiras, não emocionais; (3) concentrar-se na melhor proteção contra perda, não em 'perfumarias'; (4) manter baixo o custo dos seguros; (5) analisar seguros pessoais e comerciais." },
      { "q": "Qual a diferença entre Risco Puro e Risco Especulativo?", "a": "Risco Puro gera somente perdas, sem possibilidade de ganho (ex.: colisão de veículo) e é o único segurável. Risco Especulativo pode gerar ganho ou perda (ex.: investimentos) e não é objeto de seguro." },
      { "q": "Como se calcula o capital segurado pelo Método do Valor da Vida Humana?", "a": "Multiplica-se o valor anual que a família depende da renda do segurado pelo número de anos que ele ainda trabalharia até a aposentadoria planejada." },
      { "q": "Qual a diferença entre Cosseguro e Resseguro quanto à anuência do segurado?", "a": "O Cosseguro sempre exige anuência do segurado e só pode ser feito antes da implementação do seguro. O Resseguro não precisa da anuência do segurado, pois é uma operação exclusiva entre seguradora e resseguradora." },
      { "q": "Por que a sub-rogação não se aplica ao Seguro de Vida?", "a": "Porque a sub-rogação é o direito da seguradora de cobrar de terceiro culpado após pagar a indenização, mas na morte não há valor patrimonial mensurável a ressarcir da mesma forma — a lei exclui expressamente o seguro de vida dessa regra." },
      { "q": "Qual a diferença entre Franquia Simples e Franquia Dedutível?", "a": "Na Franquia Simples, a seguradora só indeniza se o prejuízo superar o valor da franquia, mas aí paga o valor total. Na Franquia Dedutível (a mais comum), o segurado sempre arca com o valor da franquia e a seguradora paga o restante." },
      { "q": "O que é Subseguro e como a seguradora responde nesse caso?", "a": "Ocorre quando o capital segurado é inferior ao valor do bem na data do sinistro; a seguradora só responde na proporção entre o capital segurado e o valor real do bem, nunca pelo valor total do prejuízo." },
      { "q": "Como se calcula a indenização no Risco Relativo quando o Valor em Risco Apurado (VRA) supera o Valor em Risco Declarado (VRD)?", "a": "Aplica-se a cláusula de rateio: Indenização = (VRD / VRA) x valor do dano apurado no sinistro." }
    ],
    "q": [
      { "t": "Camila tem 35 anos, pretende trabalhar até os 65 anos e sua renda líquida anual é de R$ 120.000,00. Ela consome 40% da renda para si e o restante é destinado ao sustento da família. Pelo Método do Valor da Vida Humana, qual deve ser o capital segurado do seguro de vida de Camila?", "o": ["A) R$ 2.160.000,00", "B) R$ 3.600.000,00", "C) R$ 1.800.000,00", "D) R$ 2.520.000,00"], "c": 0, "f": "Gasto anual com a família = 60% x R$ 120.000,00 = R$ 72.000,00. Período de proteção = 65 - 35 = 30 anos. Capital Segurado = 30 x R$ 72.000,00 = R$ 2.160.000,00." },
      { "t": "Uma seguradora precisa de R$ 2.000.000,00 por ano para cobrir os sinistros de uma frota de 10.000 veículos, com carregamento de segurança de 20%. Sabendo que o índice de despesas da seguradora é de 25%, qual o prêmio comercial por veículo?", "o": ["A) R$ 200,00", "B) R$ 240,00", "C) R$ 300,00", "D) R$ 320,00"], "c": 3, "f": "Prêmio de Risco por veículo = 2.000.000 / 10.000 = R$ 200,00. Prêmio Puro = 200 x 1,20 = R$ 240,00. Prêmio Comercial = 240 / (1 - 0,25) = 240 / 0,75 = R$ 320,00." },
      { "t": "Um veículo tem apólice com franquia dedutível de R$ 3.000,00. Ocorrido o sinistro, o conserto totalizou R$ 15.000,00. Qual o valor que a seguradora deverá pagar?", "o": ["A) R$ 15.000,00", "B) R$ 12.000,00", "C) R$ 3.000,00", "D) R$ 18.000,00"], "c": 1, "f": "Na franquia dedutível, o segurado sempre arca com o valor da franquia e a seguradora paga o restante: R$ 15.000,00 - R$ 3.000,00 = R$ 12.000,00." },
      { "t": "Bruno contratou um seguro com cobertura relativa e Valor em Risco Declarado (que corresponde ao LMG) de R$ 1.800.000,00. Ocorrido o sinistro, o bem foi avaliado (VRA) em R$ 4.500.000,00 e o dano apurado foi de R$ 900.000,00. Qual o valor da indenização, aplicando-se a cláusula de rateio?", "o": ["A) R$ 900.000,00", "B) R$ 450.000,00", "C) R$ 360.000,00", "D) R$ 180.000,00"], "c": 2, "f": "Como o VRA (R$ 4.500.000,00) superou o valor declarado (R$ 1.800.000,00), aplica-se o rateio: 1.800.000 / 4.500.000 = 40%. Indenização = R$ 900.000,00 x 40% = R$ 360.000,00." },
      { "t": "Uma empresa contratou seguro com cobertura total, LMG de R$ 4.000.000,00 e cláusula de rateio parcial com percentual de redução (k) de 80%. Ocorrido o sinistro, o bem foi avaliado em R$ 10.000.000,00 e o dano apurado foi de R$ 2.000.000,00. Qual o valor da indenização?", "o": ["A) R$ 800.000,00", "B) R$ 1.000.000,00", "C) R$ 1.600.000,00", "D) R$ 2.000.000,00"], "c": 1, "f": "Primeiro ajusta-se o VRA pelo percentual de redução: R$ 10.000.000,00 x 80% = R$ 8.000.000,00. Como LMG (4.000.000) é menor que esse valor ajustado, há rateio: 4.000.000 / 8.000.000 = 50%. Indenização = R$ 2.000.000,00 x 50% = R$ 1.000.000,00." }
    ],
    "al": [
      { "t": "warn", "tag": "Cosseguro x Resseguro", "txt": "Pegadinha clássica: o Cosseguro sempre exige anuência do segurado e só pode ser feito antes da implementação do seguro. Já o Resseguro nunca precisa da anuência do segurado, pois é operação entre seguradora e resseguradora." },
      { "t": "danger", "tag": "Sub-rogação e Seguro de Vida", "txt": "A sub-rogação (direito da seguradora de cobrar de terceiro culpado) NÃO se aplica ao Seguro de Vida. Também não se aplica quando o dano é causado por cônjuge, ascendente, descendente ou parente do segurado, exceto se houver dolo." },
      { "t": "warn", "tag": "Franquia Simples x Dedutível", "txt": "Não confunda: na Franquia Simples, se o prejuízo superar o valor da franquia, a seguradora paga o VALOR TOTAL. Na Franquia Dedutível (a mais cobrada em prova), o segurado sempre absorve o valor da franquia e a seguradora paga apenas a diferença." },
      { "t": "info", "tag": "Subseguro x Sobresseguro", "txt": "Subseguro: capital segurado menor que o valor do bem — indenização proporcional. Sobresseguro: mais de um seguro contratado para o mesmo bem — a soma das indenizações nunca pode ultrapassar o valor do objeto, EXCETO em seguro de vida, onde os capitais se somam integralmente." },
      { "t": "tip", "tag": "Nulidade x Anulabilidade", "txt": "Nulidade não tem prazo prescricional (pode ser alegada a qualquer tempo). Anulabilidade tem prazo de 4 anos para erro, dolo, coação, lesão e fraude contra credores, e prazo supletivo de 2 anos quando a lei não especificar." },
      { "t": "warn", "tag": "Risco Absoluto sem rateio", "txt": "Só o Risco Absoluto dispensa a cláusula de rateio (a seguradora paga até o LMG, deduzida a franquia). Risco Relativo e Risco Total sempre aplicam rateio quando o Valor em Risco Apurado (VRA) supera o valor declarado ou o LMG." }
    ],
    "conexoes": "<div class=\"content-body\"><h3>Sistema Financeiro Nacional</h3><p>A estrutura regulatória do mercado de seguros (CNSP como órgão normativo e SUSEP como órgão supervisor, vinculado ao Ministério da Fazenda) espelha a arquitetura estudada em Sistema Financeiro Nacional, onde o CMN normatiza e o BACEN supervisiona. É comum a prova cobrar o paralelo: assim como o BACEN fiscaliza bancos, a SUSEP fiscaliza seguradoras, resseguradoras, EAPCs e sociedades de capitalização, sempre subordinada às diretrizes do CNSP.</p><h3>Gestão Financeira II</h3><p>Este módulo detalha conceitos que aparecem de forma aplicada em Gestão Financeira II: o seguro prestamista (vinculado a empréstimos e financiamentos, cobrindo morte, invalidez e desemprego) e o seguro habitacional obrigatório no SFH/SFI, com suas coberturas MIP (Morte e Invalidez Permanente) e DFI (Danos Físicos ao Imóvel). Entender aqui o conceito de importância segurada e sinistro ajuda a interpretar por que a indenização do MIP quita o saldo devedor proporcionalmente à participação de cada mutuário.</p><h3>Planejamento de Aposentadoria I e II</h3><p>As Fases do Ciclo de Vida (Fundação da Riqueza, Acumulação, Conservação e Distribuição de Capital) dialogam diretamente com a lógica de acumulação e desacumulação vista em Planejamento de Aposentadoria I e II. Um cliente na fase de Conservação de Capital (40-60 anos), com filhos ainda estudando, é o perfil típico em que o planejador deve equilibrar contribuições previdenciárias com a contratação de seguro de vida dimensionado pelo Método da Avaliação das Necessidades.</p><h3>Cenário prático: conversa com cliente sobre contratar seguro de vida</h3><p>Um candidato ao CFP frequentemente precisa justificar ao cliente por que um seguro de vida é necessário mesmo tendo reserva de emergência. Aplicando as 5 Regras de Blayney, o planejador explica que a prioridade é proteger o que a família não pode perder (a renda do provedor), calcula o capital segurado pelo Método da Avaliação das Necessidades (somando inventário, ITCMD, honorários e despesas futuras) e alerta sobre carência, franquia e o fato de a indenização de seguro de vida ser isenta de Imposto de Renda — um diferencial relevante frente a outras formas de transferência patrimonial.</p></div>"
  },
  11: {
    "titulo": "Planejamento de Seguros e Gestão de Risco II",
    "exp": "<div class=\"content-body\"><h2>Seguro de Vida</h2><h3>Coberturas Básicas e Adicionais</h3><p>Toda apólice de seguro de vida exige a contratação das <strong>garantias básicas</strong>: Morte e Invalidez Permanente (perda, redução ou impotência funcional definitiva, total ou parcial, de membros ou órgãos). A partir dessa base, podem ser agregadas <strong>garantias adicionais</strong>: IPA (Invalidez Permanente Total ou Parcial por Acidente), IPTA, IPAM, IFPD (Invalidez Funcional Permanente Total por Doença), ILPD (Invalidez Laborativa Permanente Total por Doença), DMHO (Despesas Médicas, Hospitalares e Odontológicas), DIT (Diárias de Incapacidade Temporária), DIH (Diárias por Internação Hospitalar) e DG (Doenças Graves).</p><h3>Eventos Geradores de Benefício</h3><p>Três eventos podem acionar o pagamento: <strong>Sobrevivência</strong> (o segurado escolhe pagamento único ou renda imediata), <strong>Morte</strong> (paga aos beneficiários, respeitada eventual carência) e <strong>Invalidez</strong> (paga ao próprio segurado).</p><h3>Condições Gerais da Apólice</h3><ul><li><strong>Pagamento de garantia:</strong> prazo máximo de 30 dias após entrega da documentação.</li><li><strong>Prazo de Graça:</strong> mínimo de 30 dias em que a cobertura persiste mesmo com prêmio em atraso.</li><li><strong>Reabilitação:</strong> apólice cancelada por falta de pagamento pode voltar a vigorar mediante quitação do período suspenso, podendo haver novo exame ou agravamento de prêmio.</li><li><strong>Incontestabilidade:</strong> 2 anos, período em que a seguradora pode contestar o risco declarado e anular o contrato (sem má-fé do segurado).</li><li><strong>Valor de resgate</strong> e <strong>empréstimo sobre apólice:</strong> aplicáveis apenas a apólices com acumulação de capital.</li></ul><h3>Modalidades: Individual x Coletivo</h3><table class=\"data-table\"><tr><th>Característica</th><th>Individual</th><th>Coletivo</th></tr><tr><td>Contratante</td><td>PF ou PJ, cobre 1 segurado</td><td>Estipulante (empresa) representa o grupo</td></tr><tr><td>Vigência</td><td>Anual, reajuste pré-estabelecido</td><td>Contrato temporário</td></tr><tr><td>Custeio</td><td>Segurado</td><td>Estipulante não é obrigado a custear o prêmio</td></tr><tr><td>Exigências</td><td>Proposta individual</td><td>Declaração pessoal de saúde de cada segurado</td></tr></table><h3>Vida Inteira x Temporário</h3><p>O <strong>Seguro de Vida Inteira</strong> é vitalício, com prêmios pagos até o falecimento ou por prazo definido; permite resgate financeiro e só pode ser cancelado pela seguradora por falta de pagamento ou fraude. O <strong>Seguro de Vida Temporário</strong> tem duração determinada, sem acumulação de capital, prêmios mais baixos, indicado para quem precisa de proteção por período específico.</p><h3>Coberturas por Sobrevivência: Resgatável, Dotal Misto e Dotal Puro</h3><p>O <strong>Seguro Resgatável</strong> combina proteção e poupança: se o prêmio deixa de ser pago, a apólice é cancelada e o valor acumulado é devolvido (diferente da previdência privada, em que o saldo continua rendendo no FIE mesmo sem novos aportes). O <strong>Dotal Misto</strong> paga o capital segurado tanto por sobrevivência ao período de diferimento quanto por morte durante esse período (modalidade sempre de benefício definido). O <strong>Dotal Puro</strong> paga apenas ao segurado sobrevivente ao término do diferimento, sem cobertura por morte. A cobertura de <strong>Doenças Graves</strong> (AVC, câncer, Alzheimer) veda o cálculo do capital com base nas despesas médicas incorridas.</p><h3>Seguros Combinados</h3><p>Na prática do planejamento financeiro, raramente um único produto atende a todas as fases da vida do cliente. Um casal com filhos pequenos pode combinar um Vida Inteira (proteção permanente), um seguro a termo (para o período de formação dos filhos) e um seguro por sobrevivência (complemento de aposentadoria).</p><h2>Seguro Viagem</h2><p>Cobertura básica mínima de morte acidental e/ou invalidez permanente por acidente, podendo agregar extravio de bagagem, despesas médicas no exterior, atraso de voo e cancelamento de viagem. Ficam <strong>excluídos</strong>: danos à mala e seu conteúdo, confisco/apreensão alfandegária, perda de dinheiro e cheques, e depreciação normal dos objetos.</p><h2>Seguro Educacional</h2><p>Garante a continuidade dos estudos do aluno (beneficiário obrigatório) em caso de perda de renda, morte ou invalidez do responsável financeiro — que pode ser o próprio aluno a partir de 16 anos se for o pagador. A indenização pode ser mensal a anual, ou única (invalidez do estudante, dote ao final da formação, ou despesas do ano corrente). Mensalidades podem ser pagas diretamente à escola, mediante anuência do responsável.</p><h2>Auxílio Funeral e Assistência Funeral</h2><p>No <strong>Auxílio Funeral</strong>, a seguradora reembolsa os beneficiários pelos custos já incorridos, até o limite do capital segurado — o beneficiário escolhe os prestadores. Na <strong>Assistência Funeral</strong>, os serviços são prestados por rede indicada pela própria seguradora, geralmente agregada ao seguro de vida. O Auxílio Funeral tem coberturas bem inferiores às de um seguro de vida tradicional.</p><h2>Seguro de Acidentes Pessoais (AP)</h2><p>Cobre exclusivamente Morte e Invalidez Permanente <strong>decorrentes de acidente</strong> — não cobre morte por doença ou qualquer outra causa, diferentemente do seguro de vida. Por lei, é caracterizado por evento com data certa, súbito, involuntário, violento e externo. Incluem-se: suicídio e tentativas (carência de 2 anos), efeitos de temperatura/atmosfera, escapamento de gases, sequestro e alterações traumáticas da coluna comprovadas radiologicamente. A morte só é coberta a partir de 14 anos. Exclusões comuns: doenças preexistentes, esportes de alta periculosidade, LER, DORT e LTC. Por ser mais barato que o seguro de vida tradicional, o AP é excelente ferramenta complementar e especialmente indicado para a terceira idade, onde o risco de morte por acidente é proporcionalmente menor que o de morte natural.</p><h3>Invalidez Permanente por Acidente (IPA) — Tabela SUSEP</h3><p>No sinistro parcial, o percentual da tabela SUSEP é multiplicado por um grau de extensão da lesão:</p><table class=\"data-table\"><tr><th>Grau da lesão</th><th>Multiplicador</th><th>Exemplo (capital R$ 1.000.000, lesão tabelada em 20%)</th></tr><tr><td>Invalidez Permanente (100%)</td><td>100%</td><td>R$ 200.000,00</td></tr><tr><td>Grau máximo</td><td>75%</td><td>R$ 150.000,00</td></tr><tr><td>Grau médio</td><td>50%</td><td>R$ 100.000,00</td></tr><tr><td>Grau mínimo</td><td>25%</td><td>R$ 50.000,00</td></tr></table><p>Importante: mesmo que a soma de indenizações parciais superasse o capital segurado (ex.: perda de visão de um olho + perda de ambos os braços), o <strong>teto de pagamento é sempre 100% do capital contratado</strong> — nunca mais que isso.</p><h3>Outras Coberturas Adicionais do AP</h3><p><strong>DMHO</strong> reembolsa despesas médicas/hospitalares/odontológicas iniciadas nos 30 dias seguintes ao acidente, com livre escolha de prestadores; exclui convalescença, acompanhantes e próteses permanentes (exceto dentárias). <strong>DIT</strong> paga diárias por incapacidade temporária a partir do primeiro dia após o período de franquia (máximo 15 dias) — por exemplo, franquia de 10 dias com 21 dias de afastamento gera pagamento de apenas 11 diárias. Ideal para autônomos e profissionais liberais, entre 18 e 64 anos.</p><h2>Seguro Saúde e Planos de Saúde</h2><h3>ANS</h3><p>A Agência Nacional de Saúde Suplementar (ANS), vinculada ao Ministério da Saúde, regula, normatiza, controla e fiscaliza a assistência suplementar à saúde, coordenando as relações entre operadoras, prestadores e consumidores.</p><h3>Diferença entre Seguro Saúde e Plano de Saúde</h3><p>No <strong>Seguro Saúde</strong>, o segurado tem livre escolha de médico, clínica ou hospital, sendo reembolsado pela seguradora até o limite da apólice. No <strong>Plano de Saúde</strong>, o atendimento ocorre por rede credenciada pela operadora, sem livre escolha.</p><h3>Garantias</h3><p><strong>Básicas:</strong> internação, pequenas cirurgias, ambulatório, remoção médica, Rol de Procedimentos da ANS. <strong>Acessórias:</strong> consultas, exames, fisioterapia, odontologia, remissão em caso de óbito. <strong>Especiais:</strong> despesas extraordinárias, acompanhantes, enfermagem particular, internação por convalescença/senilidade.</p><h3>Carências</h3><table class=\"data-table\"><tr><th>Situação</th><th>Carência máxima</th></tr><tr><td>Regra geral</td><td>180 dias</td></tr><tr><td>Urgência e emergência</td><td>24 horas</td></tr><tr><td>Gravidez e parto</td><td>300 dias</td></tr><tr><td>Doenças/lesões preexistentes não agravadas</td><td>24 meses</td></tr></table><p>Planos coletivos empresariais com mais de 30 vidas (e coletivos por adesão de entidades de classe/cooperativas) dispensam carência. A <strong>absorção de carências</strong> permite que o novo segurado aproveite o período já cumprido em operadora concorrente.</p><h3>Alteração na Rede Hospitalar</h3><p>Não pode haver redução da oferta de serviços. Substituições precisam ser equivalentes e comunicadas ao consumidor e à ANS com 30 dias de antecedência (exceto fraude ou infração sanitária/fiscal). Se o descredenciamento ocorrer durante internação, é <strong>obrigatório</strong> que as despesas sejam pagas até a alta do paciente, cabendo à operadora arcar com os custos em casos de infração ou desligamento pleiteado pelo prestador.</p><h2>Seguro de Automóvel</h2><p>Indeniza danos materiais ao veículo segurado ou perda total. As coberturas <strong>básicas</strong> partem da Responsabilidade Civil e podem ser: Cobertura Total (Compreensiva), Incêndio e Roubo/Furto (sem colisão) ou apenas Incêndio (sem colisão e roubo). Há ainda coberturas <strong>Adicionais</strong> (kit gás, blindagem, vidros, assistência 24h, carro reserva, valor de novo), <strong>Responsabilidade Civil Facultativa (RCF-V)</strong> e <strong>Acidentes Pessoais de Passageiros (APP)</strong>.</p><h3>RCF-V e APP</h3><p>A RCF-V reembolsa o segurado por danos materiais, corporais e morais causados involuntariamente a terceiros (excluindo os passageiros do próprio veículo). A <strong>Importância Segurada</strong> é o teto de indenização; o <strong>Limite de Responsabilidade</strong> é o valor máximo por evento ou série de eventos, reduzindo o capital disponível a cada sinistro pago. Já o APP cobre os próprios passageiros (inclusive o condutor): morte paga ao cônjuge sobrevivente ou herdeiros; invalidez permanente paga ao próprio reclamante; despesas médicas são reembolsadas ao beneficiário. É obrigatório para ônibus, táxi e aplicativos de transporte.</p><h3>Taxas e Bônus</h3><p>O prêmio soma a importância segurada mais taxas calculadas por características do bem, uso, região e perfil do condutor. O <strong>Bônus</strong> é desconto progressivo por não utilização do seguro (em média 5% por classe): é pessoal e intransferível, salvo entre pais/filhos, cônjuges/companheiros ou de PJ para PF (comprovando que o novo segurado era o condutor). Trocar de seguradora ou veículo não afeta a classe; um sinistro reduz apenas 1 classe (não zera); sinistros de vidros, lanternas, faróis, retrovisores e assistência não reduzem a classe.</p><h3>Liquidação de Sinistros e Valor de Cobertura</h3><p>Em veículo financiado, o segurado pode quitar a dívida e receber o saldo, ou a seguradora paga primeiro o credor e o excedente ao segurado. O valor da indenização pode ser apurado por <strong>Valor de Mercado Referenciado (VMR)</strong> — baseado na tabela FIPE, comparável a um título pós-fixado — ou <strong>Valor Determinado (VD)</strong> — valor fixo definido na contratação, comparável a um prefixado. Quando os custos de reparo superam 75% do valor segurado, considera-se perda total.</p><h3>Franquia</h3><p>Aplicável apenas em sinistro parcial (nunca em perda total). A <strong>Franquia Básica</strong> é obrigatória; a <strong>Facultativa</strong> tem prêmio menor e franquia maior; a <strong>Reduzida</strong> tem prêmio maior e franquia menor. Regra-chave: <code>franquia e prêmio têm relação inversa</code> — quanto menor a franquia, maior o prêmio, e vice-versa.</p><h2>Seguro Residencial</h2><p>Protege o patrimônio residencial (estrutura e conteúdo), sendo obrigatória a cobertura contra <strong>Incêndio</strong>. Modalidades: <strong>Cobertura Básica</strong> (incêndio, queda de raio, explosão — comum quando o inquilino contrata e indica o proprietário como beneficiário) e <strong>Multirriscos</strong> (básica + riscos adicionais). A indenização desconsidera o valor do terreno (valor de mercado do imóvel menos o terreno). Coberturas adicionais do Multirrisco: roubo/furto qualificado, danos elétricos, perda/despesas de aluguel, Responsabilidade Civil Familiar (inclui cônjuge, filhos, empregados domésticos e animais) e despesas com mudança. A <strong>Assistência Residencial (24h)</strong> cobre chaveiro, desentupimento, serviços hidráulicos/elétricos, telhas e linha branca. Pelo Art. 785 do Código Civil, a transferência da apólice a terceiro exige aviso escrito (instrumento nominativo) ou endosso em preto (à ordem); na venda do imóvel, exige-se acordo entre vendedor, comprador e seguradora.</p><h2>Seguro de Responsabilidade Civil (RC)</h2><p>Protege o segurado contra danos materiais, corporais ou morais involuntários a terceiros — excluindo-se parentes de primeiro grau, coabitantes, cônjuge e dependentes assalariados. Ramos: RC Geral (RCG), RC Profissional (E&amp;O), RC de Diretores e Administradores (D&amp;O) e RC Riscos Ambientais.</p><h3>D&amp;O</h3><p>Protege o patrimônio pessoal de diretores, administradores, conselheiros e gerentes responsabilizados por decisões que causem danos a terceiros no exercício da função, cobrindo indenizações e custos advocatícios. Pela Circular SUSEP 553/2017, excluem-se danos causados fora do cargo, a título de cidadão comum, e danos ambientais.</p><h3>Limites de Responsabilidade: Agregado x Por Sinistro</h3><p>O <strong>Limite Agregado</strong> é o teto total da apólice na vigência; a <strong>Importância Segurada</strong> é o teto por sinistro individual. Exemplo com limite agregado de R$ 500.000 e importância segurada de R$ 200.000 por evento:</p><table class=\"data-table\"><tr><th>Sinistro</th><th>Valor do sinistro</th><th>Reembolsado</th><th>Acumulado</th></tr><tr><td>1º</td><td>R$ 200.000</td><td>R$ 200.000</td><td>R$ 200.000</td></tr><tr><td>2º</td><td>R$ 250.000</td><td>R$ 200.000 (limite por sinistro)</td><td>R$ 400.000</td></tr><tr><td>3º</td><td>R$ 300.000</td><td>R$ 100.000 (resta do agregado)</td><td>R$ 500.000</td></tr></table><h2>Seguro Garantia</h2><p>Garante o cumprimento de obrigações do tomador junto ao segurado. Três modalidades: <strong>Contratual (PJ)</strong> — concorrência, construção, fornecimento, prestação de serviço, retenção/adiantamento de pagamentos, perfeito funcionamento, imobiliária; <strong>Judicial (PJ)</strong> — cobre depósitos judiciais exigidos em ações contra o tomador; <strong>Locatícia (PF)</strong> — o chamado seguro fiança, garante o aluguel ao proprietário caso o inquilino não pague, podendo incluir IPTU.</p><h2>Seguro Crédito Exportação (SCE)</h2><p>Protege operações de crédito à exportação contra riscos comerciais, políticos e extraordinários, cobrindo produção destinada à exportação, exportações brasileiras e exportações estrangeiras associadas a componentes ou serviços brasileiros (regido pela Lei 6.704). É relevante diante da volatilidade cambial que afeta a competitividade dos exportadores brasileiros.</p><h2>Seguro Rural</h2><p>Abrange Agrícola (danos e perdas agrícolas), Pecuário (morte de animais), Florestas (danos a florestas já formadas) e Penhor Rural (bens dados em garantia rural), protegendo o produtor contra fenômenos climáticos adversos e servindo de garantia a financiadores e parceiros de negócio.</p><h2>Aspectos Tributários dos Seguros</h2><h3>IOF</h3><p>O IOF incide sobre o <strong>prêmio pago</strong>, nunca sobre a indenização. São isentos/alíquota zero: resseguro, seguro habitacional (SFH), crédito à exportação e transporte internacional, seguro garantia, seguro rural, e (a partir de 01/01/2026) planos de seguro de vida com cobertura por sobrevivência quando a soma anual de prêmios da pessoa física, em uma ou mais seguradoras, for de até <code>R$ 600.000,00</code> — o excedente é tributado a 5%. Demais alíquotas: <code>0,38%</code> seguro de pessoas; <code>2,38%</code> seguros privados de assistência à saúde; <code>7,38%</code> demais seguros.</p><h3>Imposto de Renda</h3><p>Indenizações de seguro de vida recebidas por beneficiários são <strong>isentas de IR</strong>, lançadas na DIR-PF como rendimentos isentos e não tributáveis, e por não configurarem herança, não entram em inventário nem sofrem qualquer tributação. Já os resgates em planos estruturados na modalidade de <strong>Benefício Definido</strong> (dotais, dotal misto, resgatáveis na parte por sobrevivência) — pela Lei 14.803/24 — são sempre tributados pela <strong>tabela progressiva</strong>, sem opção pela regressiva: 15% de retenção no resgate, com ajuste na Declaração de Ajuste Anual seguinte, exatamente como um VGBL na tributação progressiva.</p></div>",
    "mapa": {
      "root": "Seguros e Gestão de Risco II",
      "branches": [
        { "label": "Seguro de Pessoas", "icon": "🛡️", "color": "#2E86AB", "children": [
          { "label": "Seguro de Vida", "detail": "Básicas/adicionais, Vida Inteira x Temporário, Dotal Misto/Puro, Resgatável" },
          { "label": "Seguro Viagem", "detail": "Morte acidental/invalidez, exclui bagagem e depreciação" },
          { "label": "Seguro Educacional", "detail": "Beneficiário sempre o aluno; morte/invalidez do responsável" },
          { "label": "Auxílio e Assistência Funeral", "detail": "Reembolso livre escolha x rede indicada pela seguradora" },
          { "label": "Acidentes Pessoais (AP)", "detail": "Só morte por acidente; tabela SUSEP 75/50/25%; DMHO, DIT" }
        ]},
        { "label": "Seguro Saúde", "icon": "🏥", "color": "#E63946", "children": [
          { "label": "ANS", "detail": "Agência reguladora do setor de saúde suplementar" },
          { "label": "Seguro x Plano", "detail": "Livre escolha e reembolso x rede credenciada" },
          { "label": "Carências", "detail": "180 dias regra geral; 24h urgência; 300d parto; 24m preexistente" },
          { "label": "Rede Hospitalar", "detail": "Substituição equivalente, aviso 30 dias, custeio até alta na internação" }
        ]},
        { "label": "Seguros de Danos e Responsabilidade", "icon": "🚗", "color": "#F4A261", "children": [
          { "label": "Automóvel", "detail": "RCF-V, APP, Bônus, VMR (FIPE) x VD, Franquia (relação inversa ao prêmio)" },
          { "label": "Residencial", "detail": "Básica x Multirrisco, RC Familiar, endosso Art. 785 CC" },
          { "label": "RC / D&O", "detail": "Limite agregado x importância segurada por sinistro" },
          { "label": "Garantia", "detail": "Contratual (PJ), Judicial (PJ), Locatícia/fiança (PF)" },
          { "label": "Crédito Exportação e Rural", "detail": "Riscos comerciais/políticos; agrícola, pecuário, florestas, penhor" }
        ]},
        { "label": "Aspectos Tributários", "icon": "💰", "color": "#2A9D8F", "children": [
          { "label": "IOF", "detail": "Sobre o prêmio; isenções (rural, garantia, exportação); alíquotas 0,38/2,38/7,38%" },
          { "label": "IOF sobrevivência 2026", "detail": "Isento até R$ 600.000/ano em prêmios; 5% sobre o excedente" },
          { "label": "Imposto de Renda", "detail": "Indenização de vida isenta; resgate BD sempre tabela progressiva (Lei 14.803/24)" }
        ]}
      ]
    },
    "tags": ["seguro de vida", "seguro de pessoas", "seguro saúde", "ANS", "carência", "seguro de automóvel", "franquia", "bônus", "seguro residencial", "responsabilidade civil", "D&O", "seguro garantia", "seguro rural", "seguro crédito exportação", "IOF", "imposto de renda seguros", "seguro viagem", "seguro educacional", "acidentes pessoais", "IPA", "DIT", "DMHO"],
    "fc": [
      { "q": "Qual a diferença fundamental entre Seguro de Acidentes Pessoais (AP) e Seguro de Vida quanto à cobertura por morte?", "a": "O AP cobre morte apenas por acidente; o Seguro de Vida cobre morte por qualquer causa. Por isso o AP é mais barato e é ótima ferramenta complementar, especialmente para a terceira idade." },
      { "q": "Qual o teto máximo de indenização em qualquer combinação de coberturas de Invalidez Permanente por Acidente (IPA)?", "a": "100% do capital segurado contratado, mesmo que a soma das indenizações parciais tabeladas ultrapasse esse valor." },
      { "q": "Diferencie Dotal Misto de Dotal Puro.", "a": "O Dotal Misto paga o capital tanto por sobrevivência ao período de diferimento quanto por morte durante esse período. O Dotal Puro paga apenas ao segurado sobrevivente ao final do diferimento, sem cobertura por morte." },
      { "q": "O que diferencia o Seguro Saúde do Plano de Saúde quanto à escolha de prestadores?", "a": "No Seguro Saúde há livre escolha de médico/clínica/hospital com reembolso pela seguradora; no Plano de Saúde o atendimento é restrito à rede credenciada pela operadora." },
      { "q": "Quais são as exceções à carência máxima de 180 dias nos planos de saúde?", "a": "24 horas para urgência e emergência; 300 dias para eventos ligados a gravidez e parto; 24 meses para doenças e lesões preexistentes não agravadas." },
      { "q": "Qual a relação entre o valor da franquia e o valor do prêmio no seguro de automóvel?", "a": "Relação inversa: quanto menor a franquia, maior o prêmio; quanto maior a franquia, menor o prêmio." },
      { "q": "O que acontece com a classe de Bônus do segurado quando ele utiliza o seguro-auto em um sinistro?", "a": "A classe não zera; ela é reduzida em apenas 1 nível. Sinistros de vidros, lanternas, faróis, retrovisores e assistência não reduzem a classe." },
      { "q": "Diferencie Valor de Mercado Referenciado (VMR) de Valor Determinado (VD) no seguro de automóvel.", "a": "VMR é variável, apurado pela tabela FIPE no momento do sinistro (análogo a um título pós-fixado). VD é fixo, definido na contratação e impresso na apólice (análogo a um título prefixado)." },
      { "q": "Qual a diferença entre Limite Agregado e Importância Segurada (limite por sinistro) num seguro de Responsabilidade Civil?", "a": "O Limite Agregado é o teto total que a apólice paga durante toda a vigência; a Importância Segurada é o teto pago por evento individual. A cada indenização, o valor pago é descontado do limite agregado remanescente." },
      { "q": "Quais riscos a Circular SUSEP 553/2017 exclui do D&O?", "a": "Danos causados a terceiros a título de cidadão comum (fora da função), danos causados fora do cargo de trabalho e danos ambientais." },
      { "q": "Qual a alíquota de IOF aplicável aos seguros de pessoas e às demais operações de seguro em geral?", "a": "0,38% para seguro de pessoas; 2,38% para seguros privados de assistência à saúde; 7,38% para os demais seguros." },
      { "q": "A partir de quando e sob qual condição os planos de seguro de vida com cobertura por sobrevivência passam a ter isenção de IOF?", "a": "A partir de 01/01/2026, quando a soma anual dos prêmios pagos pela pessoa física (em uma ou mais seguradoras) for de até R$ 600.000,00; o valor excedente é tributado a 5%." }
    ],
    "q": [
      { "t": "Um cliente contratou Seguro de Acidentes Pessoais com capital segurado (IPA) de R$ 1.000.000,00. Ele sofre um acidente que, pela tabela SUSEP, corresponde a uma lesão tabelada em 20% da importância segurada, classificada pela perícia como grau máximo de extensão. Qual o valor da indenização?", "o": ["A) R$ 200.000,00", "B) R$ 150.000,00", "C) R$ 100.000,00", "D) R$ 50.000,00"], "c": 1, "f": "O valor de invalidez permanente (100%) para essa lesão seria de 20% × R$ 1.000.000 = R$ 200.000. Como a lesão foi classificada em grau máximo, aplica-se o multiplicador de 75% sobre esse valor: R$ 200.000 × 75% = R$ 150.000,00. Os graus médio (50%) e mínimo (25%) resultariam em R$ 100.000 e R$ 50.000, respectivamente — por isso são distratores." },
      { "t": "Uma apólice de Responsabilidade Civil possui Limite Agregado de R$ 400.000,00 e Importância Segurada (limite por sinistro) de R$ 150.000,00. Durante a vigência, o segurado tem 3 sinistros de R$ 150.000,00 cada. Qual valor a seguradora reembolsa no terceiro sinistro?", "o": ["A) R$ 150.000,00", "B) R$ 0,00", "C) R$ 100.000,00", "D) R$ 400.000,00"], "c": 2, "f": "1º sinistro: paga R$ 150.000 (acumulado R$ 150.000). 2º sinistro: paga R$ 150.000 (acumulado R$ 300.000). 3º sinistro: o valor pedido é R$ 150.000, mas resta apenas R$ 400.000 − R$ 300.000 = R$ 100.000 do limite agregado, portanto a seguradora paga somente R$ 100.000,00, respeitando o teto agregado da apólice." },
      { "t": "Um cliente quer reduzir o prêmio anual do seguro do seu automóvel, mantendo a cobertura compreensiva (todos os itens básicos). Ele está disposto a arcar com um valor maior em caso de sinistro parcial. Qual tipo de franquia deve ser recomendado?", "o": ["A) Franquia Reduzida", "B) Franquia Facultativa", "C) Franquia Básica obrigatória apenas", "D) Eliminar a franquia contratando cobertura Incêndio apenas"], "c": 1, "f": "A Franquia Facultativa oferece prêmio menor em troca de um valor de franquia (contrapartida do segurado em sinistro parcial) maior que a franquia básica — exatamente o perfil de risco descrito. A Franquia Reduzida faz o oposto (prêmio maior, franquia menor) e não atende ao objetivo do cliente. Migrar para cobertura apenas Incêndio reduziria a proteção contratada (perderia colisão e roubo/furto), o que não foi solicitado." },
      { "t": "Em 2026, uma pessoa física paga R$ 700.000,00 em prêmios anuais de planos de seguro de vida com cobertura por sobrevivência, somando os valores em duas seguradoras diferentes. Qual o valor de IOF devido?", "o": ["A) R$ 26.600,00 (7,38% sobre o total)", "B) R$ 5.000,00 (5% sobre o excedente de R$ 100.000)", "C) R$ 2.660,00 (0,38% sobre o total)", "D) R$ 0,00, pois há isenção total"], "c": 1, "f": "A partir de 01/01/2026, os prêmios de planos de vida com cobertura por sobrevivência são isentos de IOF até a soma anual de R$ 600.000,00 por pessoa física, somando-se todas as seguradoras. O valor que excede esse limite é tributado à alíquota de 5%. Excedente = R$ 700.000 − R$ 600.000 = R$ 100.000; IOF = R$ 100.000 × 5% = R$ 5.000,00." }
    ],
    "al": [
      { "t": "danger", "tag": "IPA", "txt": "O teto de pagamento em Invalidez Permanente por Acidente é sempre 100% do capital segurado contratado — mesmo que a soma de indenizações parciais tabeladas (ex.: perda de um olho + perda de ambos os braços) ultrapasse esse valor na conta bruta." },
      { "t": "warn", "tag": "Franquia", "txt": "Pegadinha clássica de prova: franquia e prêmio têm relação INVERSA. Menor franquia = maior prêmio. Maior franquia = menor prêmio. A franquia só se aplica a sinistro parcial, nunca em perda total." },
      { "t": "tip", "tag": "AP x Vida", "txt": "O Seguro de Acidentes Pessoais cobre morte apenas por acidente (não por doença ou idade), o que o torna mais barato que o seguro de vida tradicional e uma ótima ferramenta complementar de proteção, especialmente para clientes na terceira idade." },
      { "t": "info", "tag": "Carência ANS", "txt": "A carência máxima em planos de saúde é 180 dias, com exceções de 24h (urgência/emergência), 300 dias (parto) e 24 meses (doença preexistente não agravada). Planos coletivos empresariais com mais de 30 vidas dispensam carência." },
      { "t": "danger", "tag": "Tributação BD", "txt": "Pela Lei 14.803/24, resgates de planos estruturados em Benefício Definido (dotais, dotal misto, resgatáveis na parte por sobrevivência) são SEMPRE tributados pela tabela progressiva — não há opção pela tabela regressiva, diferentemente de outros produtos de acumulação." }
    ],
    "conexoes": "<div class=\"content-body\"><h3>Seguro de Vida por Sobrevivência x Planejamento de Aposentadoria I e II</h3><p>O Dotal Misto, o Dotal Puro e o Seguro Resgatável competem diretamente com VGBL/PGBL como instrumentos de acumulação: todos são estruturados na modalidade de benefício definido e, pela Lei 14.803/24, submetidos à tabela progressiva sem opção pela regressiva no resgate. A diferença operacional central estudada em Planejamento de Aposentadoria I e II é que, na previdência privada, a ausência de novas contribuições não cancela o plano (o saldo continua rendendo dentro do FIE), enquanto no seguro resgatável a falta de pagamento do prêmio cancela a apólice e libera o valor acumulado ao beneficiário — uma diferença estrutural que muda a recomendação para clientes com fluxo de caixa irregular.</p><h3>IOF sobre Seguros de Vida com Cobertura por Sobrevivência x Renda Fixa</h3><p>A nova isenção de IOF (a partir de 01/01/2026) até R$ 600.000 anuais em prêmios de planos com cobertura por sobrevivência dialoga com os conceitos de tributação sobre aplicações estudados em Renda Fixa I: assim como títulos isentos de IR (LCI/LCA) competem com CDBs tributados, o seguro de vida com cobertura por sobrevivência dentro do limite de isenção passa a competir com produtos de renda fixa tributados pelo IOF regressivo em resgates de curto prazo, tornando-se ferramenta de gestão tributária dentro do planejamento financeiro global do cliente.</p><h3>Seguro Garantia Locatício e Fluxo de Caixa Pessoal</h3><p>O seguro fiança (Locatícia) substitui a caução tradicional em contratos de locação e impacta diretamente a análise de fluxo de caixa e liquidez discutida em Gestão Financeira I e II: ao evitar a imobilização de um depósito caução (normalmente três aluguéis), o inquilino preserva capital de giro ou reserva de emergência que poderia ser direcionado a outras metas do planejamento financeiro, pagando em contrapartida um prêmio recorrente que deve ser incorporado ao orçamento doméstico.</p><h3>Seguro Crédito Exportação e o Sistema Financeiro Nacional</h3><p>O Seguro Crédito Exportação (SCE), regido pela Lei 6.704, conecta-se ao arcabouço estudado em Sistema Financeiro Nacional e Fundamentos de Economia: ele mitiga o risco cambial e político das exportadoras brasileiras, complementando os instrumentos de hedge cambial (mercado futuro de dólar, NDF) e sustentando a competitividade externa em cenários de volatilidade do câmbio — tema recorrente na análise macroeconômica que baliza recomendações de exposição internacional na carteira do cliente.</p><h3>Cenário prático: o profissional liberal e o DIT</h3><p>Um planejador que atenda um médico autônomo, sem vínculo CLT e, portanto, sem auxílio-doença do INSS equivalente ao de um empregado celetista, encontra no DIT (Diárias de Incapacidade Temporária) — cobertura adicional ao Seguro de Vida Individual ou ao Seguro de Acidentes Pessoais — a ferramenta correta para substituir renda durante afastamento por doença ou acidente, sempre atentando à franquia contratada (máximo 15 dias) antes de recomendar o produto como pilar da proteção de renda do cliente.</p></div>"
  },
  12: {
    "titulo": "Planejamento Tributário I",
    "exp": "<div class=\"content-body\"><h2>Fundamentos da Tributação e Princípios Constitucionais</h2><p>A tributação organiza a relação entre Estado e contribuinte a partir de conceitos básicos — tributo, obrigação tributária, fato gerador, base de cálculo e alíquota — e de princípios constitucionais que limitam o poder de tributar. Para o planejador CFP, dominar essa estrutura é o que permite diferenciar corretamente <strong>imunidade</strong> de <strong>isenção</strong>, identificar o ente competente para cada tributo e antecipar o impacto fiscal de decisões de investimento, sucessão e renda.</p><h3>Conceito de Tributo e Elementos da Obrigação Tributária</h3><p>O <strong>Código Tributário Nacional (CTN)</strong> define tributo como toda prestação pecuniária compulsória, em moeda ou cujo valor nela possa se exprimir, que não constitua sanção por ato ilícito, instituída em lei e cobrada mediante atividade administrativa plenamente vinculada. A partir dessa definição, a obrigação tributária nasce com a ocorrência do <strong>fato gerador</strong>, analisado por cinco critérios: <strong>Temporal</strong> (quando ocorreu), <strong>Espacial</strong> (onde ocorreu), <strong>Material</strong> (qual evento econômico/jurídico ocorreu), <strong>Pessoal</strong> (sujeito ativo e sujeito passivo) e <strong>Quantitativo</strong> (base de cálculo e alíquota). O <strong>sujeito ativo</strong> é o ente competente para exigir o tributo (ex.: a União no IR); o <strong>sujeito passivo</strong> pode ser <strong>contribuinte</strong> (relação direta com o fato gerador) ou <strong>responsável tributário</strong> (a lei atribui a terceiro o dever de reter e recolher, como a fonte pagadora no IRRF sobre salários). O CTN classifica a obrigação em <strong>principal</strong> (pagamento do tributo/multa) e <strong>acessória</strong> (deveres administrativos, como emitir nota fiscal). A fórmula estrutural de qualquer tributo é <code>Imposto = Base Tributária x Alíquota</code>.</p><h3>Espécies Tributárias</h3><table class=\"data-table\"><tr><th>Espécie</th><th>Conceito</th><th>Exemplo</th></tr><tr><td>Impostos</td><td>Independem de atividade estatal específica em relação ao contribuinte</td><td>IR, IPTU, IPVA</td></tr><tr><td>Taxas</td><td>Poder de polícia ou serviço público específico e divisível</td><td>Coleta de lixo, fiscalização</td></tr><tr><td>Contribuição de Melhoria</td><td>Obra pública que gera valorização imobiliária</td><td>Pavimentação de ruas</td></tr><tr><td>Contribuições Sociais</td><td>Financiamento de atividades específicas do Estado</td><td>INSS, PIS, COFINS</td></tr><tr><td>Empréstimos Compulsórios</td><td>Extraordinários e restituíveis, exclusivos da União</td><td>Guerra ou calamidade pública</td></tr></table><h3>Princípios Constitucionais Tributários</h3><p>Os princípios cobrados no exame limitam o poder de tributar: <strong>Legalidade</strong> (só lei cria/majora tributo, com exceções extrafiscais para II, IE, IPI e IOF), <strong>Isonomia</strong> (contribuintes em situação equivalente recebem tratamento igual), <strong>Irretroatividade</strong> (a lei não atinge fatos geradores anteriores à sua vigência, sem exceções constitucionais), <strong>Capacidade Contributiva</strong> (tributação proporcional à condição econômica, base da progressividade do IR), <strong>Competência</strong> (divisão constitucional do poder de tributar, indelegável, embora arrecadação/fiscalização possam ser delegadas, como no ITR), e <strong>Vedação ao Confisco</strong> (a carga tributária não pode ser excessiva a ponto de comprometer o patrimônio do contribuinte). Os princípios da <strong>Anterioridade Anual</strong> (não cobrar no mesmo exercício financeiro da lei) e <strong>Anterioridade Nonagesimal</strong> (mínimo de 90 dias entre a publicação e a cobrança) seguem a tabela abaixo:</p><table class=\"data-table\"><tr><th>Tributo</th><th>Anterioridade Anual</th><th>Anterioridade Nonagesimal</th></tr><tr><td>II, IE, IEG, IOF</td><td>Não respeita</td><td>Não respeita</td></tr><tr><td>IPI</td><td>Não respeita</td><td>Respeita</td></tr><tr><td>Imposto de Renda (IR)</td><td>Respeita</td><td>Não respeita</td></tr><tr><td>ITCMD e ITBI</td><td>Respeita</td><td>Respeita</td></tr></table><h3>Competência Tributária: União, Estados e Municípios</h3><table class=\"data-table\"><tr><th>União</th><th>Estado</th><th>Município</th></tr><tr><td>IOF, IPI, ITR, IR, II, IE, Grandes Fortunas, Empréstimos Compulsórios, Contribuições (CSLL, PIS)</td><td>ITCMD, ICMS, IPVA</td><td>IPTU, ITBI, ISS</td></tr><tr><td colspan=\"3\">Taxas e Contribuição de Melhoria: competência de cada ente conforme sua atividade administrativa</td></tr></table><h3>Imunidade x Isenção</h3><p>A <strong>imunidade</strong> tem previsão direta na Constituição Federal e <strong>limita a própria competência tributária</strong> do Estado — aplica-se apenas a impostos (entes públicos, templos religiosos, partidos políticos, entidades sindicais, instituições de educação/assistência sem fins lucrativos, livros e periódicos). Já a <strong>isenção</strong> tem natureza infraconstitucional: o tributo existe juridicamente, mas uma lei específica do ente competente dispensa sua cobrança em hipóteses previstas — podendo ser revogada por lei posterior (diferente da imunidade). Poupança, LCI e LCA são exemplos clássicos de isenção do IR para pessoas físicas.</p><h2>ITCMD e ITBI</h2><h3>ITCMD: Conceito, Fato Gerador e Competência</h3><p>O <strong>ITCMD</strong> (Imposto sobre Transmissão Causa Mortis e Doação) é tributo <strong>estadual</strong> (art. 155 da CF) que incide sobre transferência gratuita de bens e direitos — por herança (ITCM) ou doação em vida (ITCD). O sujeito passivo é o herdeiro/legatário (herança) ou o donatário (doação). Quanto à <strong>competência</strong>: em <strong>bens imóveis</strong>, pertence ao Estado onde o imóvel está localizado; em <strong>bens móveis, aplicações financeiras e quotas societárias</strong>, prevalece o Estado do domicílio do doador ou do falecido.</p><h3>ITCMD: Base de Cálculo, Alíquota e Isenções em São Paulo</h3><p>A base de cálculo é o <strong>valor de mercado</strong> do bem na data do fato gerador (permitida a dedução de dívidas do <em>de cujus</em>, quando comprovadas e preexistentes). Em quotas/ações sem liquidez recente em bolsa, usa-se metodologia de avaliação considerando, no mínimo, o patrimônio líquido a mercado acrescido do fundo de comércio. <strong>Doações sucessivas entre as mesmas partes se somam</strong> para fins de enquadramento na alíquota progressiva. A <strong>alíquota</strong> é fixada por cada Estado, respeitando o teto de <strong>8%</strong> estabelecido pelo Senado Federal, sendo obrigatória a progressividade. Em São Paulo há isenção para doações de até <strong>2.500 UFESPs</strong> (aproximadamente R$ 92.550,00 em 2025, considerando UFESP de R$ 37,02) e aplicações financeiras até 1.000 UFESPs. Um ponto de prova recorrente: o <strong>ITCMD não incide</strong> sobre benefício decorrente de contrato de previdência privada, seguro ou pecúlio.</p><h3>ITCMD: Elementos no Exterior (LC 227/2026)</h3><p>A <strong>LC 227/2026</strong> encerrou a lacuna que impedia os Estados de cobrar ITCMD sobre heranças/doações de bens no exterior sem lei complementar federal (entendimento anterior do STF). Agora, em bens móveis, aplicações financeiras, quotas e trusts no exterior, o imposto pertence ao Estado vinculado ao <strong>elemento de conexão brasileiro</strong> (domicílio do herdeiro/donatário residente no Brasil); em <strong>imóveis situados no Brasil</strong>, mantém-se a regra da localização do bem.</p><h3>ITBI: Conceito e Imunidade na Integralização de Capital</h3><p>O <strong>ITBI</strong> é tributo <strong>municipal</strong> incidente sobre transmissões onerosas de imóveis, com competência do Município onde o imóvel está localizado. A LC 227/2026 reforçou que a base de cálculo deve refletir o <strong>valor venal de mercado</strong>, admitida contestação administrativa pelo contribuinte. Há <strong>imunidade</strong> na integralização de imóveis ao capital social de pessoa jurídica, exceto quando a atividade preponderante da empresa for imobiliária.</p><h2>Imposto de Renda da Pessoa Física: Conceitos e Tabelas</h2><h3>Conceito de Renda, Fato Gerador e Fundamentos</h3><p>A <strong>renda</strong> é o acréscimo patrimonial do contribuinte (trabalho, capital ou ambos), incluindo <strong>proventos de qualquer natureza</strong> (prêmios, ganhos eventuais). O <strong>fato gerador</strong> do IR ocorre com a disponibilidade econômica (recebimento efetivo) ou jurídica (direito de receber) da renda. Três fundamentos orientam sua aplicação: <strong>Generalidade</strong> (todos que realizam o fato gerador se sujeitam ao imposto, salvo imunidade/isenção), <strong>Universalidade</strong> (todos os rendimentos compõem a base tributável, qualquer que seja a origem) e <strong>Progressividade</strong> (alíquotas crescentes conforme a renda, aplicando a capacidade contributiva).</p><h3>Formas de Recolhimento: Retenção na Fonte, Carnê-Leão e GCAP</h3><p>Quando a fonte pagadora é <strong>pessoa jurídica</strong> (salário, pró-labore, aluguel pago por empresa), ela retém e recolhe o IRRF. Em relações <strong>entre pessoas físicas</strong> (aluguel recebido de pessoa física, trabalho autônomo), o próprio beneficiário recolhe mensalmente via <strong>Carnê-Leão</strong>. Na alienação de bens e direitos (imóveis, veículos, participações societárias), o contribuinte apura e recolhe via <strong>GCAP</strong> (Ganho de Capital), com tributação exclusiva/definitiva.</p><h3>Tabela Progressiva Mensal e Anual do IRPF (2026/2027) e Redução da Lei nº 15.270/2025</h3><table class=\"data-table\"><tr><th>Base de Cálculo Mensal</th><th>Alíquota</th><th>Parcela a Deduzir</th></tr><tr><td>Até R$ 2.428,80</td><td>0,00%</td><td>R$ 0,00</td></tr><tr><td>De R$ 2.428,81 até R$ 2.826,65</td><td>7,50%</td><td>R$ 182,16</td></tr><tr><td>De R$ 2.826,66 até R$ 3.751,05</td><td>15,00%</td><td>R$ 394,16</td></tr><tr><td>De R$ 3.751,06 até R$ 4.664,68</td><td>22,50%</td><td>R$ 675,49</td></tr><tr><td>Acima de R$ 4.664,68</td><td>27,50%</td><td>R$ 908,73</td></tr></table><p>Dedução mensal por dependente: R$ 189,59. Desconto simplificado mensal: 25% do limite da faixa isenta, limitado a R$ 607,20. Além da tabela tradicional, a <strong>Lei nº 15.270/2025</strong> criou uma <strong>Redução Mensal (RM)</strong>: rendimentos até R$ 5.000,00 têm o imposto zerado; de R$ 5.000,01 a R$ 7.350,00, aplica-se <code>RM = R$ 978,62 – (0,133145 x rendimento tributável)</code>, decrescendo linearmente até zerar em R$ 7.350,00. No anual, o imposto some até R$ 60.000,00 e a redução segue <code>RM = R$ 8.429,73 – (0,095575 x rendimento tributável anual)</code> até zerar em R$ 88.200,00. O redutor não gera imposto negativo nem restituição extra.</p><h3>Cálculo do IRRF Mensal — Exemplo Numérico</h3><p>Empregado com salário bruto de <strong>R$ 5.500,00</strong> em 2026 e contribuição previdenciária de <strong>R$ 580,00</strong>. Base tributável = R$ 5.500,00 – R$ 580,00 = R$ 4.920,00, na faixa acima de R$ 4.664,68 (27,5%, PD R$ 908,73): <code>IRRF inicial = R$ 4.920,00 x 27,5% – R$ 908,73 = R$ 1.353,00 – R$ 908,73 = R$ 444,27</code>. Como o salário está entre R$ 5.000,01 e R$ 7.350,00, aplica-se a redução: <code>RM = R$ 978,62 – (0,133145 x R$ 5.500,00) = R$ 978,62 – R$ 732,30 = R$ 246,32</code>. <strong>IRRF final = R$ 444,27 – R$ 246,32 = R$ 197,95</strong>.</p><h3>Declaração Completa x Simplificada</h3><p>O contribuinte escolhe, a cada ano, entre a <strong>Declaração Completa</strong> (deduções legais: dependentes, instrução, saúde sem limite, previdência oficial, PGBL até 12% da renda tributável, pensão alimentícia) e a <strong>Declaração Simplificada</strong> (desconto padrão de 20% da renda bruta compensável, limitado a R$ 17.640,00). Exemplo: contribuinte com pró-labore de R$ 550.000,00, IR retido de R$ 112.080,00, 4 dependentes, PGBL de R$ 80.000,00 (limitado a 12% = R$ 66.000,00), despesas médicas de R$ 70.000,00 e INSS de R$ 11.857,10. Na <strong>Simplificada</strong>: base R$ 532.360,00, IRPF de R$ 135.494,34, resultando em <strong>R$ 23.414,34 a pagar</strong>. Na <strong>Completa</strong>: deduções totais de R$ 156.957,30, base R$ 393.042,70, IRPF de R$ 97.182,08, resultando em <strong>R$ 14.897,92 a restituir</strong> — evidenciando que, com deduções elevadas, a Completa é mais vantajosa.</p><h2>Tributação Exclusiva/Definitiva, Ganho de Capital e Isenções</h2><h3>Rendimentos Sujeitos à Tributação Exclusiva/Definitiva</h3><p>Nessa modalidade, o imposto recolhido <strong>encerra</strong> a obrigação, sem compensação na declaração anual: ganho de capital na alienação de bens; rendimentos de aplicações financeiras; <strong>Juros sobre Capital Próprio</strong> (17,5%); prêmios de loteria/sorteios/capitalização (30%). 13º salário e PLR seguem tabela progressiva própria, mas também de forma exclusiva.</p><h3>Ganho de Capital na Alienação de Bens e Direitos: Tabela Progressiva</h3><table class=\"data-table\"><tr><th>Faixa de Ganho</th><th>Alíquota</th></tr><tr><td>Até R$ 5 milhões</td><td>15,00%</td></tr><tr><td>De R$ 5 a R$ 10 milhões</td><td>17,50%</td></tr><tr><td>De R$ 10 a R$ 30 milhões</td><td>20,00%</td></tr><tr><td>Acima de R$ 30 milhões</td><td>22,50%</td></tr></table><p>Exemplo: venda fora de bolsa com ganho de capital de <strong>R$ 40.000.000,00</strong>. <code>5.000.000 x 15% = R$ 750.000</code>; <code>5.000.000 x 17,5% = R$ 875.000</code>; <code>20.000.000 x 20% = R$ 4.000.000</code>; <code>10.000.000 x 22,5% = R$ 2.250.000</code>. <strong>Total = R$ 7.875.000,00</strong> — a alíquota mais alta incide apenas sobre a fatia que excede cada faixa, nunca sobre o ganho total.</p><h3>Alienações a Prazo</h3><p>O ganho de capital é apurado como venda à vista, mas o imposto pode ser recolhido <strong>proporcionalmente a cada parcela recebida</strong> (forma definitiva). Exemplo: bem declarado por R$ 300.000,00, vendido por R$ 1.500.000,00 em 60 parcelas iguais de R$ 25.000,00. Lucro de R$ 1.200.000,00 (80% do valor de venda), alíquota de 15% (ganho abaixo de R$ 5 milhões): <code>IR por parcela = (R$ 25.000,00 x 80%) x 15% = R$ 20.000,00 x 15% = R$ 3.000,00</code> — o mesmo resultado de dividir o imposto total (R$ 180.000,00) pelas 60 parcelas.</p><h3>Rendimentos Isentos: Bens de Pequeno Valor e Imóveis</h3><p>Há isenção de IR sobre ganho de capital em vendas mensais de até <strong>R$ 20 mil</strong> em ações no mercado à vista e ouro ativo financeiro (exceto day trade), e de até <strong>R$ 35 mil</strong> nos demais bens da mesma natureza (FIIs, BDRs e ativos no exterior não têm essa isenção). Em imóveis: a <strong>Janela dos 180 dias</strong> isenta o ganho quando o valor é reinvestido em imóvel residencial no Brasil nesse prazo (uma vez a cada 5 anos); o <strong>único imóvel de até R$ 440 mil</strong> tem isenção total (uma vez a cada 5 anos); e imóveis adquiridos <strong>até 1969</strong> têm redução de 100% do ganho tributável, com redução decrescente de 5% ao ano para aquisições entre 1970 e 1988.</p></div>",
    "mapa": {
      "root": "Planejamento Tributário I",
      "branches": [
        { "label": "Fundamentos e Princípios", "icon": "🏛️", "color": "#1e40af", "children": [
          { "label": "Tributo (CTN)", "detail": "Prestação pecuniária compulsória, não sancionatória, instituída em lei" },
          { "label": "Fato Gerador", "detail": "Critérios Temporal, Espacial, Material, Pessoal e Quantitativo" },
          { "label": "Legalidade e Anterioridade", "detail": "Anual + nonagesimal; exceções para II, IE, IPI, IOF" },
          { "label": "Imunidade x Isenção", "detail": "Imunidade limita a competência (CF); isenção é dispensa legal revogável" },
          { "label": "Competência", "detail": "União (IR, IPI, IOF), Estado (ITCMD, ICMS, IPVA), Município (IPTU, ITBI, ISS)" }
        ]},
        { "label": "ITCMD e ITBI", "icon": "🏠", "color": "#b91c1c", "children": [
          { "label": "ITCMD Competência", "detail": "Imóvel: local do bem. Móveis/aplicações: domicílio do doador/falecido" },
          { "label": "ITCMD Alíquota", "detail": "Progressiva, teto de 8% fixado pelo Senado" },
          { "label": "Isenções SP", "detail": "Doações até 2.500 UFESPs (~R$ 92.550); não incide sobre previdência/seguro" },
          { "label": "LC 227/2026", "detail": "ITCMD sobre bens no exterior: elemento de conexão brasileiro do herdeiro/donatário" },
          { "label": "ITBI", "detail": "Municipal, valor venal de mercado, imunidade na integralização de capital" }
        ]},
        { "label": "IRPF: Tabelas e Recolhimento", "icon": "💰", "color": "#047857", "children": [
          { "label": "Fundamentos do IR", "detail": "Generalidade, Universalidade, Progressividade" },
          { "label": "Formas de Recolhimento", "detail": "Retenção na fonte, Carnê-Leão (PF a PF), GCAP (bens/direitos)" },
          { "label": "Tabela Progressiva 2026/2027", "detail": "0% a 27,5%, com Parcela a Deduzir por faixa" },
          { "label": "Redução Lei 15.270/2025", "detail": "Zera IR até R$ 5.000 mensal / R$ 60.000 anual, com transição linear" },
          { "label": "Completa x Simplificada", "detail": "Deduções reais x desconto de 20% limitado a R$ 17.640" }
        ]},
        { "label": "Tributação Exclusiva e Ganho de Capital", "icon": "📈", "color": "#7c3aed", "children": [
          { "label": "Exclusiva/Definitiva", "detail": "JCP (17,5%), prêmios (30%), ganho de capital, renda fixa" },
          { "label": "Tabela do Ganho de Capital", "detail": "15% até R$ 5 mi, até 22,5% acima de R$ 30 mi, por faixa" },
          { "label": "Alienações a Prazo", "detail": "Imposto recolhido proporcionalmente a cada parcela recebida" },
          { "label": "Bens de Pequeno Valor", "detail": "Isenção: R$ 20 mil/mês (ações/ouro) e R$ 35 mil/mês (demais bens)" }
        ]},
        { "label": "Isenções em Imóveis", "icon": "🏡", "color": "#ea580c", "children": [
          { "label": "Janela dos 180 Dias", "detail": "Reinvestimento em imóvel residencial no Brasil, 1x a cada 5 anos" },
          { "label": "Único Imóvel (R$ 440 mil)", "detail": "Isenção total, 1x a cada 5 anos, por coproprietário" },
          { "label": "Imóveis Antigos", "detail": "100% de redução até 1969; -5% ao ano de 1970 a 1988" }
        ]}
      ]
    },
    "tags": ["Planejamento Tributário", "IRPF", "ITCMD", "ITBI", "Fato Gerador", "Base de Cálculo", "Alíquota", "Princípios Constitucionais Tributários", "Imunidade", "Isenção", "Tabela Progressiva", "Ganho de Capital", "Carnê-Leão", "GCAP", "Declaração Completa", "Declaração Simplificada", "Competência Tributária", "Anterioridade", "Tributação Exclusiva"],
    "fc": [
      { "q": "Como o CTN define tributo?", "a": "Toda prestação pecuniária compulsória, em moeda ou cujo valor nela possa se exprimir, que não constitua sanção por ato ilícito, instituída em lei e cobrada mediante atividade administrativa plenamente vinculada." },
      { "q": "Quais são os cinco critérios para identificar o fato gerador de um tributo?", "a": "Temporal (quando), Espacial (onde), Material (qual evento), Pessoal (sujeito ativo e passivo) e Quantitativo (base de cálculo e alíquota)." },
      { "q": "Qual a diferença essencial entre imunidade e isenção tributária?", "a": "A imunidade tem previsão constitucional e limita a própria competência do Estado para tributar (só se aplica a impostos). A isenção é um benefício infraconstitucional: o tributo existe juridicamente, mas a cobrança é dispensada por lei específica, podendo ser revogada por legislação posterior." },
      { "q": "Quais tributos não respeitam nem a anterioridade anual nem a nonagesimal?", "a": "Imposto de Importação (II), Imposto de Exportação (IE), Imposto Extraordinário de Guerra (IEG) e IOF." },
      { "q": "Qual o teto de alíquota do ITCMD e quem o fixa?", "a": "8%, fixado pelo Senado Federal, sendo obrigatória a progressividade das alíquotas estaduais." },
      { "q": "Sobre quais benefícios o ITCMD não incide, mesmo havendo transmissão de valores ao beneficiário?", "a": "Benefícios devidos em razão de contrato de previdência privada complementar (aberta ou fechada), seguro ou pecúlio." },
      { "q": "Qual ente é competente para cobrar o ITBI e sobre qual base de cálculo?", "a": "O Município onde o imóvel está localizado, incidindo sobre o valor venal de mercado do imóvel na data da transmissão." },
      { "q": "O que muda na incidência do ITCMD sobre patrimônio no exterior após a LC 227/2026?", "a": "Passa a ser exigível: em bens móveis, aplicações financeiras e quotas no exterior, o imposto pertence ao Estado do elemento de conexão brasileiro (domicílio do herdeiro/donatário residente no Brasil); em imóveis no Brasil, mantém-se a regra da localização do bem." },
      { "q": "Quais são os três fundamentos do Imposto de Renda previstos na legislação?", "a": "Generalidade (todos que realizam o fato gerador se sujeitam ao imposto, salvo isenção/imunidade), Universalidade (todos os rendimentos compõem a base tributável) e Progressividade (alíquotas crescentes conforme a renda)." },
      { "q": "Quando o próprio contribuinte pessoa física deve recolher o IR via Carnê-Leão em vez de sofrer retenção na fonte?", "a": "Quando recebe rendimentos de outra pessoa física sem retenção direta, como aluguel pago por pessoa física ou receita de trabalho autônomo." },
      { "q": "Até que percentual da renda bruta tributável a contribuição a um PGBL é dedutível na Declaração Completa?", "a": "Até 12% da renda bruta tributável compensável; o valor que exceder esse limite não pode ser deduzido no ano." },
      { "q": "Quais os limites mensais de isenção de IR sobre ganho de capital na venda de bens de pequeno valor?", "a": "R$ 20 mil por mês para ações no mercado à vista e ouro ativo financeiro (exceto day trade); R$ 35 mil por mês para os demais bens e direitos de mesma natureza." }
    ],
    "q": [
      { "t": "Um empregado recebeu salário bruto de R$ 5.500,00 em 2026, com desconto de contribuição previdenciária (INSS) de R$ 580,00. Considerando a tabela progressiva mensal e a Redução Mensal instituída pela Lei nº 15.270/2025, qual o valor do IRRF a ser retido pela empresa?", "o": ["A) R$ 444,27", "B) R$ 197,95", "C) R$ 246,32", "D) R$ 0,00 (isento)"], "c": 1, "f": "Base tributável = R$ 5.500,00 – R$ 580,00 = R$ 4.920,00, na faixa acima de R$ 4.664,68 (alíquota 27,5%, PD R$ 908,73). IRRF inicial = R$ 4.920,00 x 27,5% – R$ 908,73 = R$ 1.353,00 – R$ 908,73 = R$ 444,27. Como o salário de R$ 5.500,00 está entre R$ 5.000,01 e R$ 7.350,00, aplica-se a Redução Mensal: RM = R$ 978,62 – (0,133145 x R$ 5.500,00) = R$ 978,62 – R$ 732,30 = R$ 246,32. IRRF final = R$ 444,27 – R$ 246,32 = R$ 197,95." },
      { "t": "Um contribuinte vendeu, fora de bolsa de valores, uma participação societária apurando ganho de capital de R$ 40.000.000,00. Considerando a tabela progressiva de ganho de capital, qual o Imposto de Renda total devido?", "o": ["A) R$ 7.875.000,00", "B) R$ 9.000.000,00", "C) R$ 6.000.000,00", "D) R$ 8.500.000,00"], "c": 0, "f": "A alíquota progressiva incide por faixa, não sobre o valor total: até R$ 5 milhões (15%) = R$ 750.000,00; de R$ 5 a 10 milhões (17,5% sobre R$ 5.000.000,00) = R$ 875.000,00; de R$ 10 a 30 milhões (20% sobre R$ 20.000.000,00) = R$ 4.000.000,00; acima de R$ 30 milhões (22,5% sobre os R$ 10.000.000,00 restantes) = R$ 2.250.000,00. Total = R$ 750.000,00 + R$ 875.000,00 + R$ 4.000.000,00 + R$ 2.250.000,00 = R$ 7.875.000,00." },
      { "t": "Um contribuinte vendeu um bem declarado por R$ 300.000,00 pelo valor de R$ 1.500.000,00, a ser recebido em 60 parcelas mensais e iguais de R$ 25.000,00. Considerando a tributação proporcional das alienações a prazo e alíquota de 15% (ganho abaixo de R$ 5 milhões), qual o IR devido em cada parcela recebida?", "o": ["A) R$ 3.000,00", "B) R$ 3.750,00", "C) R$ 2.250,00", "D) R$ 1.200,00"], "c": 0, "f": "O lucro total da operação é R$ 1.500.000,00 – R$ 300.000,00 = R$ 1.200.000,00, correspondente a 80% do valor de venda à vista. Em cada parcela de R$ 25.000,00, a base tributária é 80% x R$ 25.000,00 = R$ 20.000,00. IR da parcela = R$ 20.000,00 x 15% = R$ 3.000,00, o que também pode ser obtido dividindo o imposto total (15% x R$ 1.200.000,00 = R$ 180.000,00) pelas 60 parcelas (R$ 180.000,00 / 60 = R$ 3.000,00)." },
      { "t": "Em 2025, um contribuinte residente em São Paulo recebeu doação em dinheiro de seu pai no valor de R$ 80.000,00, sem qualquer doação anterior entre as mesmas partes no mesmo período. Considerando a isenção estadual de ITCMD sobre doações de até 2.500 UFESPs (UFESP de R$ 37,02), essa doação estará sujeita à cobrança do imposto?", "o": ["A) Não, pois R$ 80.000,00 é inferior ao limite de isenção de aproximadamente R$ 92.550,00", "B) Sim, pois toda doação em dinheiro é tributada independentemente do valor", "C) Sim, mas apenas sobre o valor que exceder R$ 37.020,00", "D) Não, pois doações entre pais e filhos são sempre imunes"], "c": 0, "f": "O limite de isenção de doações no Estado de São Paulo é de 2.500 UFESPs. Com UFESP de R$ 37,02, o limite corresponde a 2.500 x R$ 37,02 = R$ 92.550,00. Como a doação de R$ 80.000,00 é inferior a esse limite e não há doações anteriores a somar na mesma faixa progressiva, a operação está isenta do ITCMD. Não se trata de imunidade constitucional, mas de isenção prevista em lei estadual, que poderia ser alterada por legislação posterior." },
      { "t": "Um empregado possui salário de contribuição de R$ 3.500,00 em 2026. Considerando a tabela progressiva do INSS (faixa de R$ 2.902,85 a R$ 4.354,27: alíquota de 12%, parcela a deduzir de R$ 111,40), qual o valor da contribuição previdenciária mensal descontada?", "o": ["A) R$ 308,60", "B) R$ 420,00", "C) R$ 315,00", "D) R$ 288,60"], "c": 0, "f": "Como no IRPF, as alíquotas do INSS incidem sobre faixas progressivas, aplicando-se a alíquota da faixa final com dedução de uma parcela para simplificar o cálculo. INSS = R$ 3.500,00 x 12% – R$ 111,40 = R$ 420,00 – R$ 111,40 = R$ 308,60." }
    ],
    "al": [
      { "t": "danger", "tag": "Imunidade x Isenção", "txt": "Não confunda: a imunidade tem previsão na Constituição Federal e limita a própria competência tributária do Estado (só afeta impostos). A isenção é um benefício de lei ordinária/complementar estadual ou federal, pode ser revogada a qualquer momento e não impede a competência — apenas dispensa a cobrança em hipóteses específicas." },
      { "t": "warn", "tag": "Limite de 12% do PGBL", "txt": "A dedução da contribuição a PGBL na Declaração Completa está limitada a 12% da renda bruta tributável anual. Contribuições acima desse teto (como no exemplo do Sr. Rafael, que aportou R$ 80.000,00 mas só pôde deduzir R$ 66.000,00) não geram benefício fiscal adicional no ano-calendário." },
      { "t": "tip", "tag": "Tabela da Anterioridade", "txt": "Memorize: II, IE, IEG e IOF não respeitam nenhuma anterioridade (podem ser cobrados imediatamente); o IPI só respeita a nonagesimal; o Imposto de Renda só respeita a anual; ITCMD e ITBI respeitam as duas." },
      { "t": "info", "tag": "ITCMD não incide sobre previdência e seguro", "txt": "O ITCMD não incide sobre benefício devido em razão de contrato de previdência privada complementar (aberta ou fechada), de seguro ou de pecúlio — um dos motivos pelos quais esses instrumentos são frequentemente usados no planejamento sucessório para transmitir recursos fora do inventário e sem incidência do imposto estadual." },
      { "t": "danger", "tag": "Isenção de bens de pequeno valor não é cumulativa entre categorias", "txt": "O limite de isenção de R$ 20 mil/mês (ações e ouro ativo financeiro) e de R$ 35 mil/mês (demais bens) aplica-se por mês e por conjunto de bens da mesma natureza vendidos no período — não é um limite único somado entre categorias distintas, nem se acumula de um mês para o outro." }
    ]
  }
};
...
const MODS = [
  ...
  { id: 10, n: "10", name: "Planejamento de Seguros e Gestão de Risco I", cfp_mod: 5 },
  { id: 11, n: "11", name: "Planejamento de Seguros e Gestão de Risco II", cfp_mod: 5 },
  { id: 12, n: "12", name: "Planejamento Tributário I", cfp_mod: 6 }
];
